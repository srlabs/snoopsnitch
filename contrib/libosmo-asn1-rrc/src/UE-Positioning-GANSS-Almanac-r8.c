...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_Almanac_r8_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ganss-wk-number at 18774 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* alm-keplerianParameters at 18775 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* alm-keplerianNAVAlmanac at 18776 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* alm-keplerianReducedAlmanac at 18777 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* alm-keplerianMidiAlmanac at 18778 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* alm-keplerianGLONASS at 18779 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* alm-ecefSBASAlmanac at 18780 */
};
