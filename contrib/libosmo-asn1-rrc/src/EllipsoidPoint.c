...
static asn_TYPE_member_t asn_MBR_EllipsoidPoint_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EllipsoidPoint, latitudeSign),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EllipsoidPoint, latitude),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EllipsoidPoint, longitude),
...
static ber_tlv_tag_t asn_DEF_EllipsoidPoint_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_EllipsoidPoint_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* latitudeSign at 13745 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* latitude at 13746 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* longitude at 13747 */
};
static asn_SEQUENCE_specifics_t asn_SPC_EllipsoidPoint_specs_1 = {
	sizeof(struct EllipsoidPoint),
	offsetof(struct EllipsoidPoint, _asn_ctx),
	asn_MAP_EllipsoidPoint_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_EllipsoidPoint = {
	"EllipsoidPoint",
	"EllipsoidPoint",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_EllipsoidPoint_tags_1,
	sizeof(asn_DEF_EllipsoidPoint_tags_1)
		/sizeof(asn_DEF_EllipsoidPoint_tags_1[0]), /* 1 */
	asn_DEF_EllipsoidPoint_tags_1,	/* Same as above */
	sizeof(asn_DEF_EllipsoidPoint_tags_1)
		/sizeof(asn_DEF_EllipsoidPoint_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_EllipsoidPoint_1,
	3,	/* Elements count */
	&asn_SPC_EllipsoidPoint_specs_1	/* Additional specs */
};
