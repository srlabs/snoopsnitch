...
static asn_TYPE_member_t asn_MBR_DSCH_Mapping_1[] = {
...
static ber_tlv_tag_t asn_DEF_DSCH_Mapping_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DSCH_Mapping_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* maxTFCI-Field2Value at 7963 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* spreadingFactor at 7964 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* codeNumber at 7965 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* multiCodeInfo at 7967 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DSCH_Mapping_specs_1 = {
