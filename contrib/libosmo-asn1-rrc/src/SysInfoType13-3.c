...
static int asn_MAP_SysInfoType13_3_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_SysInfoType13_3_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SysInfoType13_3_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ansi-41-PrivateNeighbourListInfo at 21429 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 21431 */
};
