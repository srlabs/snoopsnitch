...
static asn_TYPE_member_t asn_MBR_CompressedModeMeasCapabTDD_1[] = {
...
static ber_tlv_tag_t asn_DEF_CompressedModeMeasCapabTDD_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CompressedModeMeasCapabTDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioFrequencyBandTDD at 961 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dl-MeasurementsTDD at 962 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ul-MeasurementsTDD at 963 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CompressedModeMeasCapabTDD_specs_1 = {
