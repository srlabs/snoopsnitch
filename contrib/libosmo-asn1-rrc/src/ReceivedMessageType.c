...
static asn_per_constraints_t asn_PER_type_ReceivedMessageType_constr_1 = {
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (0..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_ReceivedMessageType_value2enum_1[] = {
...
static unsigned int asn_MAP_ReceivedMessageType_enum2value_1[] = {
	0,	/* activeSetUpdate(0) */
...
static asn_INTEGER_specifics_t asn_SPC_ReceivedMessageType_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_ReceivedMessageType_tags_1[] = {
