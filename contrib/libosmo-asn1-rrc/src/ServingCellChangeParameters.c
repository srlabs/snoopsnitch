...
static asn_TYPE_member_t asn_MBR_ServingCellChangeParameters_1[] = {
...
static ber_tlv_tag_t asn_DEF_ServingCellChangeParameters_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ServingCellChangeParameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* servingCellChangeMACreset at 11234 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* servingCellChangeMsgType at 11235 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* servingCellChangeTrId at 11237 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ServingCellChangeParameters_specs_1 = {
