...
static asn_TYPE_member_t asn_MBR_InterFreqMeasurementSysInfo_HCS_RSCP_1[] = {
...
static int asn_MAP_InterFreqMeasurementSysInfo_HCS_RSCP_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_InterFreqMeasurementSysInfo_HCS_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqMeasurementSysInfo_HCS_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* interFreqCellInfoSI-List at 15242 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqMeasurementSysInfo_HCS_RSCP_specs_1 = {
