...
static asn_TYPE_tag2member_t asn_MAP_SysInfoTypeSB2_v860ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* extSIBTypeInfoSchedulingInfo-List at 21891 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* extGANSS-SIBTypeInfoSchedulingInfoList at 21893 */
};
