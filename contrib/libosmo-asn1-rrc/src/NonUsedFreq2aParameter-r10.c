...
static asn_TYPE_member_t asn_MBR_NonUsedFreq2aParameter_r10_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NonUsedFreq2aParameter_r10, nonUsedFreqW),
	...
	{ ATF_POINTER, 1, offsetof(struct NonUsedFreq2aParameter_r10, nonUsedFreqTriggeringConditionDetectedCells),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_NonUsedFreq2aParameter_r10_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_NonUsedFreq2aParameter_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NonUsedFreq2aParameter_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nonUsedFreqW at 17674 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonUsedFreqTriggeringConditionDetectedCells at 17675 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NonUsedFreq2aParameter_r10_specs_1 = {
	sizeof(struct NonUsedFreq2aParameter_r10),
	offsetof(struct NonUsedFreq2aParameter_r10, _asn_ctx),
	asn_MAP_NonUsedFreq2aParameter_r10_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_NonUsedFreq2aParameter_r10_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_NonUsedFreq2aParameter_r10 = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_NonUsedFreq2aParameter_r10_tags_1,
	sizeof(asn_DEF_NonUsedFreq2aParameter_r10_tags_1)
		/sizeof(asn_DEF_NonUsedFreq2aParameter_r10_tags_1[0]), /* 1 */
	asn_DEF_NonUsedFreq2aParameter_r10_tags_1,	/* Same as above */
	sizeof(asn_DEF_NonUsedFreq2aParameter_r10_tags_1)
		/sizeof(asn_DEF_NonUsedFreq2aParameter_r10_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_NonUsedFreq2aParameter_r10_1,
	2,	/* Elements count */
	&asn_SPC_NonUsedFreq2aParameter_r10_specs_1	/* Additional specs */
};
