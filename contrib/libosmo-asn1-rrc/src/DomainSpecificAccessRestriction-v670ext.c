...
static asn_per_constraints_t asn_PER_type_DomainSpecificAccessRestriction_v670ext_constr_1 = {
...
static int asn_MAP_restriction_oms_3[] = { 0 };
static ber_tlv_tag_t asn_DEF_restriction_tags_3[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_restriction_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* domainSpecficAccessClassBarredList at 551 */
};
...
static asn_TYPE_member_t asn_MBR_DomainSpecificAccessRestriction_v670ext_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_DomainSpecificAccessRestriction_v670ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* noRestriction at 549 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* restriction at 551 */
};
static asn_CHOICE_specifics_t asn_SPC_DomainSpecificAccessRestriction_v670ext_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_DomainSpecificAccessRestriction_v670ext = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_DomainSpecificAccessRestriction_v670ext_constr_1,
