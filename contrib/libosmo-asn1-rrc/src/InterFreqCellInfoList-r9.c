...
static asn_TYPE_member_t asn_MBR_InterFreqCellInfoList_r9_1[] = {
...
static int asn_MAP_InterFreqCellInfoList_r9_oms_1[] = { 0, 1, 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_InterFreqCellInfoList_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqCellInfoList_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterFreqCellList at 15032 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* newInterFreqCellList at 15033 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cellsForInterFreqMeasList at 15034 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* cSGInterFreqCellInfoList at 15035 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* interFreqSIAcquisition at 15036 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqCellInfoList_r9_specs_1 = {
