...
static int
memb_nextSchedulingperiod_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_nextSchedulingperiod_constr_4 = {
	{ APC_CONSTRAINED,	 5,  5,  0,  31 }	/* (0..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_MBMS_ServiceSchedulingInfo_r6_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MBMS_ServiceSchedulingInfo_r6, nextSchedulingperiod),
		...
		memb_nextSchedulingperiod_constraint_1,
		&asn_PER_memb_nextSchedulingperiod_constr_4,
		0,
		"nextSchedulingperiod"
		},
};
static int asn_MAP_MBMS_ServiceSchedulingInfo_r6_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_MBMS_ServiceSchedulingInfo_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MBMS_ServiceSchedulingInfo_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mbms-TransmissionIdentity at 22369 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* mbms-ServiceTransmInfoList at 22370 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nextSchedulingperiod at 22371 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MBMS_ServiceSchedulingInfo_r6_specs_1 = {
