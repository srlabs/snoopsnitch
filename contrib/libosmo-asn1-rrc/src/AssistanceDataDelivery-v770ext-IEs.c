...
static asn_TYPE_tag2member_t asn_MAP_AssistanceDataDelivery_v770ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-Positioning-OTDOA-AssistanceData-UEB-ext at 1059 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-Positioning-GPS-AssistanceData at 1060 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ue-positioning-GANSS-AssistanceData at 1061 */
};
