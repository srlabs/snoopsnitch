...
static asn_TYPE_member_t asn_MBR_UL_AddReconfTransChInformation_1[] = {
...
static ber_tlv_tag_t asn_DEF_UL_AddReconfTransChInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UL_AddReconfTransChInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-TransportChannelType at 5795 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* transportChannelIdentity at 5796 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* transportFormatSet at 5798 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UL_AddReconfTransChInformation_specs_1 = {
