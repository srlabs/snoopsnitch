...
static asn_TYPE_tag2member_t asn_MAP_tfs_SignallingMode_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* explicit-config at 5093 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* sameAsULTrCH at 5094 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hsdsch at 5096 */
};
...
static asn_TYPE_member_t asn_MBR_DL_AddReconfTransChInformation_r9_1[] = {
...
static int asn_MAP_DL_AddReconfTransChInformation_r9_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_DL_AddReconfTransChInformation_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DL_AddReconfTransChInformation_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-TransportChannelType at 5091 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfs-SignallingMode at 5093 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dch-QualityTarget at 5097 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DL_AddReconfTransChInformation_r9_specs_1 = {
