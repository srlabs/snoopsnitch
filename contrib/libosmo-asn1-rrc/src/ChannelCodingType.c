...
static asn_per_constraints_t asn_PER_type_ChannelCodingType_constr_1 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_ChannelCodingType_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_ChannelCodingType_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* noCoding at 4867 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* convolutional at 4868 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* turbo at 4869 */
};
static asn_CHOICE_specifics_t asn_SPC_ChannelCodingType_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ChannelCodingType = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_ChannelCodingType_constr_1,
