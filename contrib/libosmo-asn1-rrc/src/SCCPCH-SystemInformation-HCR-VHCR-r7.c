...
static asn_TYPE_member_t asn_MBR_SCCPCH_SystemInformation_HCR_VHCR_r7_1[] = {
...
static int asn_MAP_SCCPCH_SystemInformation_HCR_VHCR_r7_oms_1[] = { 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_SCCPCH_SystemInformation_HCR_VHCR_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SCCPCH_SystemInformation_HCR_VHCR_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondaryCCPCH-Info at 10972 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfcs at 10973 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* fach-PCH-InformationList at 10974 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* pich-Info at 10975 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SCCPCH_SystemInformation_HCR_VHCR_r7_specs_1 = {
