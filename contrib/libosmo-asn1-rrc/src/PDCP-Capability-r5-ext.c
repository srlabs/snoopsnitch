...
static int asn_MAP_PDCP_Capability_r5_ext_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_PDCP_Capability_r5_ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PDCP_Capability_r5_ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportForRfc3095ContextRelocation at 1768 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* maxHcContextSpace at 1769 */
};
