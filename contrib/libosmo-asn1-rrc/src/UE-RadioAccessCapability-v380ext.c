...
static asn_TYPE_member_t asn_MBR_UE_RadioAccessCapability_v380ext_1[] = {
...
static ber_tlv_tag_t asn_DEF_UE_RadioAccessCapability_v380ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapability_v380ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-PositioningCapabilityExt-v380 at 2844 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_RadioAccessCapability_v380ext_specs_1 = {
