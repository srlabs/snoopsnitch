...
static asn_TYPE_member_t asn_MBR_InterFreqEventResults_1[] = {
...
static int asn_MAP_InterFreqEventResults_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_InterFreqEventResults_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqEventResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventID at 15185 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* interFreqCellList at 15186 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqEventResults_specs_1 = {
