...
static asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-QualMin at 13435 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* q-RxlevMin at 13436 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* q-RxlevMin at 13439 */
};
...
static asn_TYPE_tag2member_t asn_MAP_gsm_tag2el_11[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* q-RxlevMin at 13442 */
};
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 13435 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd at 13439 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* gsm at 13442 */
};
...
static asn_TYPE_member_t asn_MBR_CellSelectReselectInfoSIB_11_12_HCS_RSCP_1[] = {
...
static int asn_MAP_CellSelectReselectInfoSIB_11_12_HCS_RSCP_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_CellSelectReselectInfoSIB_11_12_HCS_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoSIB_11_12_HCS_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-OffsetS-N at 13429 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* maxAllowedUL-TX-Power at 13430 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* hcs-NeighbouringCellInformation-RSCP at 13432 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* modeSpecificInfo at 13437 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CellSelectReselectInfoSIB_11_12_HCS_RSCP_specs_1 = {
