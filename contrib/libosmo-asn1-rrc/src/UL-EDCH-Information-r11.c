...
static asn_TYPE_member_t asn_MBR_fdd_5[] = {
	{ ATF_POINTER, 6, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, e_DPCCH_Info),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 5, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, e_DPDCH_Info),
	...
	{ ATF_POINTER, 4, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, ul_MIMO_Info),
	...
	{ ATF_POINTER, 3, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, schedulingTransmConfiguration),
	...
	{ ATF_POINTER, 2, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, ul_16QAM_Settings),
	...
	{ ATF_POINTER, 1, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, ul_64QAM_Settings),
...
static int asn_MAP_fdd_oms_5[] = { 0, 1, 2, 3, 4, 5 };
static ber_tlv_tag_t asn_DEF_fdd_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* e-DPCCH-Info at 12585 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-DPDCH-Info at 12586 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ul-MIMO-Info at 12587 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* schedulingTransmConfiguration at 12588 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* ul-16QAM-Settings at 12589 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* ul-64QAM-Settings at 12590 */
};
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_5 = {
	sizeof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd),
	offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd_12[] = {
	{ ATF_POINTER, 3, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__tdd, e_RUCCH_Info),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__tdd, e_PUCH_Info),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_E_PUCH_Info,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_POINTER, 1, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__tdd, non_ScheduledTransGrantInfo),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_12[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* e-RUCCH-Info at 12593 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-PUCH-Info at 12594 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* non-ScheduledTransGrantInfo at 12595 */
};
static asn_SEQUENCE_specifics_t asn_SPC_tdd_specs_12 = {
	sizeof(struct UL_EDCH_Information_r11__modeSpecificInfo__tdd),
	offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo__tdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_5,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd_12,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 12585 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd at 12593 */
};
static asn_CHOICE_specifics_t asn_SPC_modeSpecificInfo_specs_4 = {
	sizeof(struct UL_EDCH_Information_r11__modeSpecificInfo),
	offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo, _asn_ctx),
	offsetof(struct UL_EDCH_Information_r11__modeSpecificInfo, present),
	sizeof(((struct UL_EDCH_Information_r11__modeSpecificInfo *)0)->present),
...
static asn_TYPE_member_t asn_MBR_UL_EDCH_Information_r11_1[] = {
	{ ATF_POINTER, 1, offsetof(struct UL_EDCH_Information_r11, mac_es_e_resetIndicator),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_EDCH_Information_r11, modeSpecificInfo),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static int asn_MAP_UL_EDCH_Information_r11_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_UL_EDCH_Information_r11_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UL_EDCH_Information_r11_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-es-e-resetIndicator at 12582 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* modeSpecificInfo at 12591 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UL_EDCH_Information_r11_specs_1 = {
	sizeof(struct UL_EDCH_Information_r11),
	offsetof(struct UL_EDCH_Information_r11, _asn_ctx),
	asn_MAP_UL_EDCH_Information_r11_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_UL_EDCH_Information_r11_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_UL_EDCH_Information_r11 = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UL_EDCH_Information_r11_tags_1,
	sizeof(asn_DEF_UL_EDCH_Information_r11_tags_1)
		/sizeof(asn_DEF_UL_EDCH_Information_r11_tags_1[0]), /* 1 */
	asn_DEF_UL_EDCH_Information_r11_tags_1,	/* Same as above */
	sizeof(asn_DEF_UL_EDCH_Information_r11_tags_1)
		/sizeof(asn_DEF_UL_EDCH_Information_r11_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_UL_EDCH_Information_r11_1,
	2,	/* Elements count */
	&asn_SPC_UL_EDCH_Information_r11_specs_1	/* Additional specs */
};
