...
static int
hS_SCCH_tpc_step_size_31_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	/* Replace with underlying type checker */
	td->check_constraints = asn_DEF_NativeEnumerated.check_constraints;
	return td->check_constraints(td, sptr, ctfailcb, app_key);
 ...
 */
static void
hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_NativeEnumerated.free_struct;
	td->print_struct   = asn_DEF_NativeEnumerated.print_struct;
	td->ber_decoder    = asn_DEF_NativeEnumerated.ber_decoder;
	td->der_encoder    = asn_DEF_NativeEnumerated.der_encoder;
...
static void
hS_SCCH_tpc_step_size_31_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

static int
hS_SCCH_tpc_step_size_31_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
		int ilevel, asn_app_consume_bytes_f *cb, void *app_key) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->print_struct(td, struct_ptr, ilevel, cb, app_key);
}
...
static asn_dec_rval_t
hS_SCCH_tpc_step_size_31_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const void *bufptr, size_t size, int tag_mode) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->ber_decoder(opt_codec_ctx, td, structure, bufptr, size, tag_mode);
}
...
static asn_enc_rval_t
hS_SCCH_tpc_step_size_31_encode_der(asn_TYPE_descriptor_t *td,
		void *structure, int tag_mode, ber_tlv_tag_t tag,
		asn_app_consume_bytes_f *cb, void *app_key) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->der_encoder(td, structure, tag_mode, tag, cb, app_key);
...
static asn_dec_rval_t
hS_SCCH_tpc_step_size_31_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		void **structure, const char *opt_mname, const void *bufptr, size_t size) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->xer_decoder(opt_codec_ctx, td, structure, opt_mname, bufptr, size);
}
...
static asn_enc_rval_t
hS_SCCH_tpc_step_size_31_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
		int ilevel, enum xer_encoder_flags_e flags,
		asn_app_consume_bytes_f *cb, void *app_key) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->xer_encoder(td, structure, ilevel, flags, cb, app_key);
...
static asn_dec_rval_t
hS_SCCH_tpc_step_size_31_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints, void **structure, asn_per_data_t *per_data) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->uper_decoder(opt_codec_ctx, td, constraints, structure, per_data);
}
...
static asn_enc_rval_t
hS_SCCH_tpc_step_size_31_encode_uper(asn_TYPE_descriptor_t *td,
		asn_per_constraints_t *constraints,
		void *structure, asn_per_outp_t *per_out) {
	hS_SCCH_tpc_step_size_31_inherit_TYPE_descriptor(td);
	return td->uper_encoder(td, constraints, structure, per_out);
...
static asn_per_constraints_t asn_PER_type_hS_SCCH_tpc_step_size_constr_31 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_hS_SCCH_SetConfiguration_constr_38 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static asn_per_constraints_t asn_PER_memb_hS_SCCH_SetConfiguration_constr_38 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 2,  2,  1,  4 }	/* (SIZE(1..4)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* hS-SCCHChannelisationCodeInfo at 9017 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-ScramblingCode at 9018 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tdd384_tag2el_8[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nack-ack-power-offset at 9022 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hs-SICH-PowerControl-Info at 9023 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* dhs-sync at 9024 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* bler-target at 9025 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* hS-SCCH-SetConfiguration at 9028 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tdd768_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nack-ack-power-offset at 9030 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hs-SICH-PowerControl-Info at 9031 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* dhs-sync at 9032 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* bler-target at 9033 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* hS-SCCH-SetConfiguration at 9036 */
};
...
static asn_INTEGER_enum_map_t asn_MAP_hS_SCCH_tpc_step_size_value2enum_31[] = {
	{ 0,	2,	"s1" },
	{ 1,	2,	"s2" },
	{ 2,	2,	"s3" },
	{ 3,	6,	"spare1" }
};
static unsigned int asn_MAP_hS_SCCH_tpc_step_size_enum2value_31[] = {
	0,	/* s1(0) */
	1,	/* s2(1) */
	2,	/* s3(2) */
	3	/* spare1(3) */
};
static asn_INTEGER_specifics_t asn_SPC_hS_SCCH_tpc_step_size_specs_31 = {
...
static ber_tlv_tag_t asn_DEF_hS_SCCH_tpc_step_size_tags_31[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_hS_SCCH_tpc_step_size_31 = {
	...
	"hS-SCCH-tpc-step-size",
	hS_SCCH_tpc_step_size_31_free,
	hS_SCCH_tpc_step_size_31_print,
	hS_SCCH_tpc_step_size_31_constraint,
	hS_SCCH_tpc_step_size_31_decode_ber,
	hS_SCCH_tpc_step_size_31_encode_der,
	hS_SCCH_tpc_step_size_31_decode_xer,
	hS_SCCH_tpc_step_size_31_encode_xer,
	hS_SCCH_tpc_step_size_31_decode_uper,
	hS_SCCH_tpc_step_size_31_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	...
	&asn_PER_type_hS_SCCH_tpc_step_size_constr_31,
	0, 0,	/* Defined elsewhere */
...
static ber_tlv_tag_t asn_DEF_hS_SCCH_SetConfiguration_tags_38[] = {
...
asn_TYPE_descriptor_t asn_DEF_hS_SCCH_SetConfiguration_38 = {
	...
	&asn_PER_type_hS_SCCH_SetConfiguration_constr_38,
...
static asn_TYPE_member_t asn_MBR_tdd128_22[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HS_SCCH_Info_r9__modeSpecificInfo__tdd__tdd128, hS_SCCH_SetConfiguration),
		...
		&asn_PER_memb_hS_SCCH_SetConfiguration_constr_38,
		0,
		"hS-SCCH-SetConfiguration"
		},
};
static int asn_MAP_tdd128_oms_22[] = { 4, 5, 6 };
static ber_tlv_tag_t asn_DEF_tdd128_tags_22[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_tdd128_tag2el_22[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nack-ack-power-offset at 9038 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* power-level-HSSICH at 9039 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* tpc-step-size at 9040 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* bler-target at 9041 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* hS-SCCH-tpc-step-size at 9042 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* powerControlGAP at 9043 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* pathlossCompensationSwitch at 9044 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* hS-SCCH-SetConfiguration at 9047 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tdd384 at 9022 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd768 at 9030 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tdd128 at 9038 */
};
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 9017 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd at 9028 */
};
...
static asn_TYPE_member_t asn_MBR_HS_SCCH_Info_r9_1[] = {
...
static ber_tlv_tag_t asn_DEF_HS_SCCH_Info_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HS_SCCH_Info_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* modeSpecificInfo at 9019 */
};
static asn_SEQUENCE_specifics_t asn_SPC_HS_SCCH_Info_r9_specs_1 = {
