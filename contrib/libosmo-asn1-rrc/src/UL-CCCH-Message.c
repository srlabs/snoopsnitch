...
static asn_TYPE_member_t asn_MBR_UL_CCCH_Message_1[] = {
	{ ATF_POINTER, 1, offsetof(struct UL_CCCH_Message, integrityCheckInfo),
...
static int asn_MAP_UL_CCCH_Message_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_UL_CCCH_Message_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UL_CCCH_Message_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* integrityCheckInfo at 245 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* message at 247 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UL_CCCH_Message_specs_1 = {
	...
	asn_MAP_UL_CCCH_Message_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
