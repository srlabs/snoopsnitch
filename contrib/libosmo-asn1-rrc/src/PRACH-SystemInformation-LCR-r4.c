...
static asn_TYPE_member_t asn_MBR_PRACH_SystemInformation_LCR_r4_1[] = {
...
static int asn_MAP_PRACH_SystemInformation_LCR_r4_oms_1[] = { 1, 2 };
static ber_tlv_tag_t asn_DEF_PRACH_SystemInformation_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PRACH_SystemInformation_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* prach-RACH-Info-LCR at 10340 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rach-TransportFormatSet-LCR at 10341 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* prach-Partitioning-LCR at 10342 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PRACH_SystemInformation_LCR_r4_specs_1 = {
