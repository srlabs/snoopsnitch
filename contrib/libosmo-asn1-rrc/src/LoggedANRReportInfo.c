...
static asn_TYPE_member_t asn_MBR_LoggedANRReportInfo_1[] = {
...
static ber_tlv_tag_t asn_DEF_LoggedANRReportInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_LoggedANRReportInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity at 16246 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* servingCell at 16247 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* loggedCellInfo at 16249 */
};
static asn_SEQUENCE_specifics_t asn_SPC_LoggedANRReportInfo_specs_1 = {
