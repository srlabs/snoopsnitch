...
static asn_TYPE_member_t asn_MBR_UE_Positioning_GANSS_AddIonoModel_1[] = {
...
static ber_tlv_tag_t asn_DEF_UE_Positioning_GANSS_AddIonoModel_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_AddIonoModel_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dataID at 18813 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* alpha-beta-parameters at 18815 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_GANSS_AddIonoModel_specs_1 = {
