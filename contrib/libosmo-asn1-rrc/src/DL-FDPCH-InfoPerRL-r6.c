...
static asn_per_constraints_t asn_PER_memb_dl_ChannelisationCode_constr_6 = {
	{ APC_CONSTRAINED,	 8,  8,  0,  255 }	/* (0..255) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_DL_FDPCH_InfoPerRL_r6_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_FDPCH_InfoPerRL_r6, dl_ChannelisationCode),
		...
		&asn_PER_memb_dl_ChannelisationCode_constr_6,
		0,
...
static int asn_MAP_DL_FDPCH_InfoPerRL_r6_oms_1[] = { 2, 3 };
static ber_tlv_tag_t asn_DEF_DL_FDPCH_InfoPerRL_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DL_FDPCH_InfoPerRL_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pCPICH-UsageForChannelEst at 7078 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fdpch-FrameOffset at 7079 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* secondaryCPICH-Info at 7080 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* secondaryScramblingCode at 7081 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* dl-ChannelisationCode at 7082 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* tpc-CombinationIndex at 7084 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DL_FDPCH_InfoPerRL_r6_specs_1 = {
