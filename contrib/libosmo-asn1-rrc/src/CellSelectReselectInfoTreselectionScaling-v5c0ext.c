...
static asn_TYPE_member_t asn_MBR_CellSelectReselectInfoTreselectionScaling_v5c0ext_1[] = {
...
static int asn_MAP_CellSelectReselectInfoTreselectionScaling_v5c0ext_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_CellSelectReselectInfoTreselectionScaling_v5c0ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoTreselectionScaling_v5c0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* non-HCS-t-CR-Max at 13483 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* speedDependentScalingFactor at 13484 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* interFrequencyTreselectionScalingFactor at 13485 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* interRATTreselectionScalingFactor at 13486 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CellSelectReselectInfoTreselectionScaling_v5c0ext_specs_1 = {
