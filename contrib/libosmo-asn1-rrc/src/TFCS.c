...
static asn_per_constraints_t asn_PER_type_TFCS_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_TFCS_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* normalTFCI-Signalling at 5676 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dummy at 5680 */
};
