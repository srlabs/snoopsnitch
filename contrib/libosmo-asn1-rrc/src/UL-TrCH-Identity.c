...
static asn_per_constraints_t asn_PER_type_UL_TrCH_Identity_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_UL_TrCH_Identity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dch at 18648 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rachorcpch at 18651 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* usch at 18653 */
};
