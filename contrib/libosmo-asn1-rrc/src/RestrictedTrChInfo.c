...
static asn_TYPE_member_t asn_MBR_RestrictedTrChInfo_1[] = {
...
static int asn_MAP_RestrictedTrChInfo_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_RestrictedTrChInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RestrictedTrChInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-TransportChannelType at 5600 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* restrictedTrChIdentity at 5601 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* allowedTFI-List at 5602 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RestrictedTrChInfo_specs_1 = {
