...
static asn_per_constraints_t asn_PER_memb_midambleShift_constr_6 = {
...
static asn_per_constraints_t asn_PER_memb_midambleConfiguration_constr_7 = {
...
static ber_tlv_tag_t asn_DEF_ueSpecificMidamble_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ueSpecificMidamble_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* midambleShift at 9581 */
};
...
static asn_TYPE_tag2member_t asn_MAP_midambleAllocationMode_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* defaultMidamble at 9578 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* commonMidamble at 9579 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ueSpecificMidamble at 9582 */
};
...
static ber_tlv_tag_t asn_DEF_MidambleShiftAndBurstType_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MidambleShiftAndBurstType_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* midambleAllocationMode at 9578 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* midambleConfiguration at 9585 */
};
