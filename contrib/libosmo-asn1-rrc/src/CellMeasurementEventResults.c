...
static asn_per_constraints_t asn_PER_type_CellMeasurementEventResults_constr_1 = {
...
static asn_SET_OF_specifics_t asn_SPC_fdd_specs_2 = {
	sizeof(struct CellMeasurementEventResults__fdd),
	offsetof(struct CellMeasurementEventResults__fdd, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_tdd_specs_4 = {
	sizeof(struct CellMeasurementEventResults__tdd),
	offsetof(struct CellMeasurementEventResults__tdd, _asn_ctx),
...
static asn_TYPE_tag2member_t asn_MAP_CellMeasurementEventResults_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 13319 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd at 13322 */
};
