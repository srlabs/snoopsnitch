...
static asn_TYPE_member_t asn_MBR_TrafficVolumeEventParam_1[] = {
...
static int asn_MAP_TrafficVolumeEventParam_oms_1[] = { 2, 3, 4 };
static ber_tlv_tag_t asn_DEF_TrafficVolumeEventParam_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TrafficVolumeEventParam_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eventID at 18322 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* reportingThreshold at 18323 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* timeToTrigger at 18324 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pendingTimeAfterTrigger at 18325 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* tx-InterruptionAfterTrigger at 18326 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TrafficVolumeEventParam_specs_1 = {
