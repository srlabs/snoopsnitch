...
static asn_TYPE_tag2member_t asn_MAP_fddRF_Capability_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-PowerClass at 2966 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* txRxFrequencySeparation at 2968 */
};
...
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapabBandFDD2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* radioFrequencyBandFDD2 at 2964 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* fddRF-Capability at 2966 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* measurementCapability2 at 2970 */
};
