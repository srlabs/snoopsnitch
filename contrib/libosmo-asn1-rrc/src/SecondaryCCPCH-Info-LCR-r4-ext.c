...
static asn_TYPE_member_t asn_MBR_SecondaryCCPCH_Info_LCR_r4_ext_1[] = {
...
static ber_tlv_tag_t asn_DEF_SecondaryCCPCH_Info_LCR_r4_ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SecondaryCCPCH_Info_LCR_r4_ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* individualTimeslotLCR-Ext at 11107 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SecondaryCCPCH_Info_LCR_r4_ext_specs_1 = {
