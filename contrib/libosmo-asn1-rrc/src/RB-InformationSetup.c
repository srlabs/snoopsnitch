...
static asn_TYPE_member_t asn_MBR_RB_InformationSetup_1[] = {
...
static int asn_MAP_RB_InformationSetup_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_RB_InformationSetup_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RB_InformationSetup_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity at 4209 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pdcp-Info at 4210 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* rlc-InfoChoice at 4211 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* rb-MappingInfo at 4213 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RB_InformationSetup_specs_1 = {
