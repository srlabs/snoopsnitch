...
static asn_TYPE_tag2member_t asn_MAP_servingGrant_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* value at 8396 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* primary-Secondary-GrantSelector at 8397 */
};
...
static asn_TYPE_tag2member_t asn_MAP_E_DPDCH_SchedulingTransmConfiguration_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ms2-SchedTransmGrantHARQAlloc at 8394 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* servingGrant at 8396 */
};
