...
static asn_TYPE_tag2member_t asn_MAP_hcr_r5_SpecificInfo_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pusch-SysInfoList-SFN at 20917 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pdsch-SysInfoList-SFN at 20918 */
};
...
static asn_TYPE_member_t asn_MBR_SysInfoType5_v590ext_IEs_1[] = {
...
static int asn_MAP_SysInfoType5_v590ext_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_SysInfoType5_v590ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SysInfoType5_v590ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* hcr-r5-SpecificInfo at 20917 */
};
static asn_SEQUENCE_specifics_t asn_SPC_SysInfoType5_v590ext_IEs_specs_1 = {
