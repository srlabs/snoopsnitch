...
static asn_TYPE_tag2member_t asn_MAP_MeasurementCapabilityExt2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* compressedModeMeasCapabFDDList at 1501 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* compressedModeMeasCapabTDDList at 1502 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* compressedModeMeasCapabGSMList at 1503 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* compressedModeMeasCapabMC at 1504 */
};
