...
static asn_TYPE_member_t asn_MBR_InterRATCellInfoList_1[] = {
...
static int asn_MAP_InterRATCellInfoList_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_InterRATCellInfoList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterRATCellInfoList_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterRATCellList at 15478 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* newInterRATCellList at 15481 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cellsForInterRATMeasList at 15482 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterRATCellInfoList_specs_1 = {
