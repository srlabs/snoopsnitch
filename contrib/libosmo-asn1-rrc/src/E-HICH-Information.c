...
static asn_TYPE_member_t asn_MBR_E_HICH_Information_1[] = {
...
static ber_tlv_tag_t asn_DEF_E_HICH_Information_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_E_HICH_Information_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* channelisationCode at 8408 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* signatureSequence at 8410 */
};
static asn_SEQUENCE_specifics_t asn_SPC_E_HICH_Information_specs_1 = {
