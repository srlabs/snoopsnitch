...
static asn_TYPE_tag2member_t asn_MAP_activate_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* tgcfn at 11602 */
};
...
static asn_TYPE_tag2member_t asn_MAP_tgps_Status_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* activate at 11602 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* deactivate at 11603 */
};
...
static asn_TYPE_member_t asn_MBR_TGP_Sequence_1[] = {
...
static int asn_MAP_TGP_Sequence_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_TGP_Sequence_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TGP_Sequence_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tgpsi at 11598 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tgps-Status at 11602 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tgps-ConfigurationParams at 11605 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TGP_Sequence_specs_1 = {
