...
static asn_TYPE_member_t asn_MBR_geran_SystemInfoType_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType, choice.sI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType, choice.pSI),
...
static asn_TYPE_tag2member_t asn_MAP_geran_SystemInfoType_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sI at 3349 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pSI at 3351 */
};
static asn_CHOICE_specifics_t asn_SPC_geran_SystemInfoType_specs_2 = {
	sizeof(struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType),
	offsetof(struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType, _asn_ctx),
	offsetof(struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType, present),
	sizeof(((struct HandoverFromUTRANCommand_GSM_v690ext_IEs__geran_SystemInfoType *)0)->present),
...
static int asn_MAP_HandoverFromUTRANCommand_GSM_v690ext_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_HandoverFromUTRANCommand_GSM_v690ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HandoverFromUTRANCommand_GSM_v690ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* geran-SystemInfoType at 3349 */
};
