...
static asn_TYPE_tag2member_t asn_MAP_MeasuredResultsOnRACHinterFreq_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* interFreqCellIndication-SIB11 at 16743 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* interFreqCellIndication-SIB12 at 16744 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* interFreqRACHRepCellsList at 16746 */
};
