...
static asn_TYPE_member_t asn_MBR_ExplicitDiscard_1[] = {
...
static ber_tlv_tag_t asn_DEF_ExplicitDiscard_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ExplicitDiscard_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* timerMRW at 3702 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* timerDiscard at 3703 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* maxMRW at 3705 */
};
static asn_SEQUENCE_specifics_t asn_SPC_ExplicitDiscard_specs_1 = {
