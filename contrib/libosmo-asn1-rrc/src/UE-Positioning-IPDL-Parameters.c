...
static int
memb_ip_Offset_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_seed_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_ip_Offset_constr_4 = {
	{ APC_CONSTRAINED,	 4,  4,  0,  9 }	/* (0..9) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_seed_constr_5 = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_UE_Positioning_IPDL_Parameters_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_Positioning_IPDL_Parameters, ip_Offset),
		...
		memb_ip_Offset_constraint_1,
		&asn_PER_memb_ip_Offset_constr_4,
		0,
		"ip-Offset"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct UE_Positioning_IPDL_Parameters, seed),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		memb_seed_constraint_1,
		&asn_PER_memb_seed_constr_5,
		0,
		"seed"
		},
...
static int asn_MAP_UE_Positioning_IPDL_Parameters_oms_1[] = { 4 };
static ber_tlv_tag_t asn_DEF_UE_Positioning_IPDL_Parameters_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_IPDL_Parameters_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ip-Spacing at 19331 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ip-Length at 19332 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* ip-Offset at 19333 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* seed at 19334 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* burstModeParameters at 19335 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_IPDL_Parameters_specs_1 = {
