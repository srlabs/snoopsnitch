...
static asn_TYPE_member_t asn_MBR_IntraFreqCellInfoSI_List_HCS_ECN0_LCR_r4_1[] = {
...
static int asn_MAP_IntraFreqCellInfoSI_List_HCS_ECN0_LCR_r4_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_IntraFreqCellInfoSI_List_HCS_ECN0_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IntraFreqCellInfoSI_List_HCS_ECN0_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedIntraFreqCellList at 15773 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* newIntraFreqCellList at 15775 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IntraFreqCellInfoSI_List_HCS_ECN0_LCR_r4_specs_1 = {
