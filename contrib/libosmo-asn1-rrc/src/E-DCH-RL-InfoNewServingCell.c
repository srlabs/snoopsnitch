...
static asn_TYPE_member_t asn_MBR_servingGrant_4[] = {
	{ ATF_POINTER, 1, offsetof(struct E_DCH_RL_InfoNewServingCell__servingGrant, value),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E_DCH_RL_InfoNewServingCell__servingGrant, primary_Secondary_GrantSelector),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_TYPE_tag2member_t asn_MAP_servingGrant_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* value at 8188 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* primary-Secondary-GrantSelector at 8189 */
};
static asn_SEQUENCE_specifics_t asn_SPC_servingGrant_specs_4 = {
	sizeof(struct E_DCH_RL_InfoNewServingCell__servingGrant),
	offsetof(struct E_DCH_RL_InfoNewServingCell__servingGrant, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_e_RGCH_Info_15[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info, choice.e_RGCH_Information),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info, choice.releaseIndicator),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_e_RGCH_Info_tag2el_15[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* e-RGCH-Information at 8198 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* releaseIndicator at 8199 */
};
static asn_CHOICE_specifics_t asn_SPC_e_RGCH_Info_specs_15 = {
	sizeof(struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info),
	offsetof(struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info, _asn_ctx),
	offsetof(struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info, present),
	sizeof(((struct E_DCH_RL_InfoNewServingCell__e_RGCH_Info *)0)->present),
...
static asn_TYPE_member_t asn_MBR_E_DCH_RL_InfoNewServingCell_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct E_DCH_RL_InfoNewServingCell, primaryCPICH_Info),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct E_DCH_RL_InfoNewServingCell, e_AGCH_Information),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 8, offsetof(struct E_DCH_RL_InfoNewServingCell, servingGrant),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct E_DCH_RL_InfoNewServingCell, e_DPCCH_DPCCH_PowerOffset),
	...
	{ ATF_POINTER, 6, offsetof(struct E_DCH_RL_InfoNewServingCell, reference_E_TFCIs),
	...
	{ ATF_POINTER, 5, offsetof(struct E_DCH_RL_InfoNewServingCell, powerOffsetForSchedInfo),
	...
	{ ATF_POINTER, 4, offsetof(struct E_DCH_RL_InfoNewServingCell, threeIndexStepThreshold),
	...
	{ ATF_POINTER, 3, offsetof(struct E_DCH_RL_InfoNewServingCell, twoIndexStepThreshold),
	...
	{ ATF_POINTER, 2, offsetof(struct E_DCH_RL_InfoNewServingCell, e_HICH_Information),
	...
	{ ATF_POINTER, 1, offsetof(struct E_DCH_RL_InfoNewServingCell, e_RGCH_Info),
...
static int asn_MAP_E_DCH_RL_InfoNewServingCell_oms_1[] = { 2, 3, 4, 5, 6, 7, 8, 9 };
static ber_tlv_tag_t asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_E_DCH_RL_InfoNewServingCell_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 8185 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-AGCH-Information at 8186 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* servingGrant at 8188 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* e-DPCCH-DPCCH-PowerOffset at 8191 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* reference-E-TFCIs at 8192 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* powerOffsetForSchedInfo at 8193 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* threeIndexStepThreshold at 8194 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 }, /* twoIndexStepThreshold at 8195 */
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* e-HICH-Information at 8196 */
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* e-RGCH-Info at 8198 */
};
static asn_SEQUENCE_specifics_t asn_SPC_E_DCH_RL_InfoNewServingCell_specs_1 = {
	sizeof(struct E_DCH_RL_InfoNewServingCell),
	offsetof(struct E_DCH_RL_InfoNewServingCell, _asn_ctx),
	asn_MAP_E_DCH_RL_InfoNewServingCell_tag2el_1,
	10,	/* Count of tags in the map */
	asn_MAP_E_DCH_RL_InfoNewServingCell_oms_1,	/* Optional members */
	8, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_E_DCH_RL_InfoNewServingCell = {
	...
	SEQUENCE_encode_uper,
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1,
	sizeof(asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1)
		/sizeof(asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1[0]), /* 1 */
	asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1,	/* Same as above */
	sizeof(asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1)
		/sizeof(asn_DEF_E_DCH_RL_InfoNewServingCell_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_E_DCH_RL_InfoNewServingCell_1,
	10,	/* Elements count */
	&asn_SPC_E_DCH_RL_InfoNewServingCell_specs_1	/* Additional specs */
};
