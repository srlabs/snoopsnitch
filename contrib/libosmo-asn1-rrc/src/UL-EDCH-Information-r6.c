...
static asn_TYPE_member_t asn_MBR_UL_EDCH_Information_r6_1[] = {
...
static int asn_MAP_UL_EDCH_Information_r6_oms_1[] = { 0, 1, 2, 3 };
static ber_tlv_tag_t asn_DEF_UL_EDCH_Information_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UL_EDCH_Information_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mac-es-e-resetIndicator at 12524 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* e-DPCCH-Info at 12525 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* e-DPDCH-Info at 12526 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* schedulingTransmConfiguration at 12527 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UL_EDCH_Information_r6_specs_1 = {
