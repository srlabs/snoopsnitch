...
static asn_TYPE_member_t asn_MBR_LastSegmentShort_1[] = {
...
static ber_tlv_tag_t asn_DEF_LastSegmentShort_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_LastSegmentShort_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sib-Type at 9426 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* segmentIndex at 9427 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* sib-Data-variable at 9429 */
};
static asn_SEQUENCE_specifics_t asn_SPC_LastSegmentShort_specs_1 = {
