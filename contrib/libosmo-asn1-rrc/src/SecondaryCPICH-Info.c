...
static int asn_MAP_SecondaryCPICH_Info_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_SecondaryCPICH_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SecondaryCPICH_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondaryDL-ScramblingCode at 11184 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* channelisationCode at 11186 */
};
