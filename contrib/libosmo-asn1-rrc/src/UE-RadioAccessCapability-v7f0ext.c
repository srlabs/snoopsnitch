...
static asn_TYPE_member_t asn_MBR_UE_RadioAccessCapability_v7f0ext_1[] = {
	{ ATF_POINTER, 3, offsetof(struct UE_RadioAccessCapability_v7f0ext, supportofTxDivOnNonMIMOChannel),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct UE_RadioAccessCapability_v7f0ext, physicalChannelCapability_LCR),
	...
	{ ATF_POINTER, 1, offsetof(struct UE_RadioAccessCapability_v7f0ext, ue_RadioAccessCapabilityComp_TDD128),
...
static int asn_MAP_UE_RadioAccessCapability_v7f0ext_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_RadioAccessCapability_v7f0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportofTxDivOnNonMIMOChannel at 2874 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* physicalChannelCapability-LCR at 2877 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* ue-RadioAccessCapabilityComp-TDD128 at 2878 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_RadioAccessCapability_v7f0ext_specs_1 = {
	sizeof(struct UE_RadioAccessCapability_v7f0ext),
	offsetof(struct UE_RadioAccessCapability_v7f0ext, _asn_ctx),
	asn_MAP_UE_RadioAccessCapability_v7f0ext_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_UE_RadioAccessCapability_v7f0ext_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_UE_RadioAccessCapability_v7f0ext = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1,
	sizeof(asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1)
		/sizeof(asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1[0]), /* 1 */
	asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1,	/* Same as above */
	sizeof(asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1)
		/sizeof(asn_DEF_UE_RadioAccessCapability_v7f0ext_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_UE_RadioAccessCapability_v7f0ext_1,
	3,	/* Elements count */
	&asn_SPC_UE_RadioAccessCapability_v7f0ext_specs_1	/* Additional specs */
};
