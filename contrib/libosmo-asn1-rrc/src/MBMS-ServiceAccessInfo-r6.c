...
static asn_TYPE_member_t asn_MBR_MBMS_ServiceAccessInfo_r6_1[] = {
...
static int asn_MAP_MBMS_ServiceAccessInfo_r6_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_MBMS_ServiceAccessInfo_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MBMS_ServiceAccessInfo_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* shortTransmissionID at 22345 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* accessprobabilityFactor-Idle at 22346 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* accessprobabilityFactor-Connected at 22347 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* mbms-ConnectedModeCountingScope at 22349 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MBMS_ServiceAccessInfo_r6_specs_1 = {
