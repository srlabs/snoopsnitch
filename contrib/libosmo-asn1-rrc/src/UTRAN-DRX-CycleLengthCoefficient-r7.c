...
static asn_TYPE_tag2member_t asn_MAP_UTRAN_DRX_CycleLengthCoefficient_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* drx-CycleLengthCoefficient at 3447 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* drx-CycleLengthCoefficient2 at 3448 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* timeForDRXCycle2 at 3449 */
};
