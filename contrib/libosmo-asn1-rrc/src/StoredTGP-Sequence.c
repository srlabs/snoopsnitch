...
static asn_TYPE_member_t asn_MBR_active_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct StoredTGP_Sequence__current_tgps_Status__active, tgcfn),
...
static asn_TYPE_tag2member_t asn_MAP_active_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* tgcfn at 755 */
};
static asn_SEQUENCE_specifics_t asn_SPC_active_specs_4 = {
	sizeof(struct StoredTGP_Sequence__current_tgps_Status__active),
	offsetof(struct StoredTGP_Sequence__current_tgps_Status__active, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_current_tgps_Status_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct StoredTGP_Sequence__current_tgps_Status, choice.active),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_active_4,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct StoredTGP_Sequence__current_tgps_Status, choice.inactive),
...
static asn_TYPE_tag2member_t asn_MAP_current_tgps_Status_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* active at 755 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* inactive at 756 */
};
static asn_CHOICE_specifics_t asn_SPC_current_tgps_Status_specs_3 = {
	sizeof(struct StoredTGP_Sequence__current_tgps_Status),
	offsetof(struct StoredTGP_Sequence__current_tgps_Status, _asn_ctx),
	offsetof(struct StoredTGP_Sequence__current_tgps_Status, present),
	sizeof(((struct StoredTGP_Sequence__current_tgps_Status *)0)->present),
...
static int asn_MAP_StoredTGP_Sequence_oms_1[] = { 2 };
static ber_tlv_tag_t asn_DEF_StoredTGP_Sequence_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_StoredTGP_Sequence_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tgpsi at 751 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* current-tgps-Status at 755 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tgps-ConfigurationParams at 758 */
};
