...
static asn_per_constraints_t asn_PER_type_RLC_InfoChoice_r5_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_RLC_InfoChoice_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rlc-Info at 4414 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* same-as-RB at 4416 */
};
