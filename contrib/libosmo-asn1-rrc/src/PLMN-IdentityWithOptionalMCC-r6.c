...
static asn_TYPE_member_t asn_MBR_PLMN_IdentityWithOptionalMCC_r6_1[] = {
...
static int asn_MAP_PLMN_IdentityWithOptionalMCC_r6_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_PLMN_IdentityWithOptionalMCC_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PLMN_IdentityWithOptionalMCC_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mcc at 391 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* mnc at 393 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PLMN_IdentityWithOptionalMCC_r6_specs_1 = {
