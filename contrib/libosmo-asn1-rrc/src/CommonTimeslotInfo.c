...
static int asn_MAP_CommonTimeslotInfo_oms_1[] = { 1, 3 };
static ber_tlv_tag_t asn_DEF_CommonTimeslotInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CommonTimeslotInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondInterleavingMode at 6489 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfci-Coding at 6490 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* puncturingLimit at 6491 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* repetitionPeriodAndLength at 6492 */
};
