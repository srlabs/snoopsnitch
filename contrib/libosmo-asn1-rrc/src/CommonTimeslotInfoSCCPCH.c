...
static asn_TYPE_member_t asn_MBR_CommonTimeslotInfoSCCPCH_1[] = {
...
static int asn_MAP_CommonTimeslotInfoSCCPCH_oms_1[] = { 1, 3 };
static ber_tlv_tag_t asn_DEF_CommonTimeslotInfoSCCPCH_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CommonTimeslotInfoSCCPCH_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* secondInterleavingMode at 6506 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tfci-Coding at 6507 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* puncturingLimit at 6508 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* repetitionPeriodLengthAndOffset at 6509 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CommonTimeslotInfoSCCPCH_specs_1 = {
