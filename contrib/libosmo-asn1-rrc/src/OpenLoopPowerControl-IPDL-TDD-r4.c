...
static ber_tlv_tag_t asn_DEF_OpenLoopPowerControl_IPDL_TDD_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_OpenLoopPowerControl_IPDL_TDD_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ipdl-alpha at 9865 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* maxPowerIncrease at 9867 */
};
