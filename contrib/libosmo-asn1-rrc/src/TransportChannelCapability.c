...
static asn_TYPE_member_t asn_MBR_TransportChannelCapability_1[] = {
...
static ber_tlv_tag_t asn_DEF_TransportChannelCapability_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TransportChannelCapability_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-TransChCapability at 2419 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ul-TransChCapability at 2421 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TransportChannelCapability_specs_1 = {
