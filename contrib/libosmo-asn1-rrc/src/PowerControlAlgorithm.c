...
static asn_per_constraints_t asn_PER_type_PowerControlAlgorithm_constr_1 = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_PowerControlAlgorithm_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_PowerControlAlgorithm_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* algorithm1 at 10176 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* algorithm2 at 10177 */
};
static asn_CHOICE_specifics_t asn_SPC_PowerControlAlgorithm_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PowerControlAlgorithm = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_PowerControlAlgorithm_constr_1,
