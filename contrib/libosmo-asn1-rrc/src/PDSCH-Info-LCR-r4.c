...
static int asn_MAP_PDSCH_Info_LCR_r4_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_PDSCH_Info_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PDSCH_Info_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* tfcs-ID at 10017 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* commonTimeslotInfo at 10018 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* pdsch-TimeslotsCodes at 10019 */
};
