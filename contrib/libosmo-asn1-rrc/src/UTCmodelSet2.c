...
static asn_per_constraints_t asn_PER_memb_kp_constr_5 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  2,  2 }	/* (SIZE(2..2)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_UTCmodelSet2_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UTCmodelSet2, nA),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UTCmodelSet2, tauC),
	...
	{ ATF_POINTER, 2, offsetof(struct UTCmodelSet2, deltaUT1),
	...
	{ ATF_POINTER, 1, offsetof(struct UTCmodelSet2, kp),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		memb_kp_constraint_1,
		&asn_PER_memb_kp_constr_5,
		0,
		"kp"
		},
};
static int asn_MAP_UTCmodelSet2_oms_1[] = { 2, 3 };
static ber_tlv_tag_t asn_DEF_UTCmodelSet2_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UTCmodelSet2_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* nA at 19896 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tauC at 19897 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* deltaUT1 at 19898 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* kp at 19899 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UTCmodelSet2_specs_1 = {
	...
	asn_MAP_UTCmodelSet2_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
