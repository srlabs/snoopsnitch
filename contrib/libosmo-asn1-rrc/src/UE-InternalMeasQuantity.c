...
static asn_TYPE_member_t asn_MBR_UE_InternalMeasQuantity_1[] = {
...
static int asn_MAP_UE_InternalMeasQuantity_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_UE_InternalMeasQuantity_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_InternalMeasQuantity_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* measurementQuantity at 18515 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* filterCoefficient at 18516 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_InternalMeasQuantity_specs_1 = {
