...
static int asn_MAP_HCS_NeighbouringCellInformation_RSCP_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_HCS_NeighbouringCellInformation_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HCS_NeighbouringCellInformation_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* hcs-PRIO at 14944 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* q-HCS at 14945 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* hcs-CellReselectInformation at 14947 */
};
