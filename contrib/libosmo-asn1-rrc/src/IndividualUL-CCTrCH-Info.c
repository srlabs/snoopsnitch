...
static asn_TYPE_member_t asn_MBR_IndividualUL_CCTrCH_Info_1[] = {
...
static ber_tlv_tag_t asn_DEF_IndividualUL_CCTrCH_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IndividualUL_CCTrCH_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-TFCS-Identity at 5400 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ul-TFCS at 5401 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* tfc-Subset at 5403 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IndividualUL_CCTrCH_Info_specs_1 = {
