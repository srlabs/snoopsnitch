...
static asn_TYPE_member_t asn_MBR_fdd_6[] = {
	{ ATF_POINTER, 2, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__fdd, q_QualMin),
	...
	{ ATF_POINTER, 1, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__fdd, q_RxlevMin),
...
static asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_6[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-QualMin at 13416 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* q-RxlevMin at 13417 */
};
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_6 = {
	sizeof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__fdd),
	offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd_9[] = {
	{ ATF_POINTER, 1, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__tdd, q_RxlevMin),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Q_RxlevMin,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* q-RxlevMin at 13420 */
};
static asn_SEQUENCE_specifics_t asn_SPC_tdd_specs_9 = {
	sizeof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__tdd),
	offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__tdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_gsm_11[] = {
	{ ATF_POINTER, 1, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__gsm, q_RxlevMin),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_Q_RxlevMin,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_gsm_tag2el_11[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* q-RxlevMin at 13423 */
};
static asn_SEQUENCE_specifics_t asn_SPC_gsm_specs_11 = {
	sizeof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__gsm),
	offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo__gsm, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_6,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd_9,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo, choice.gsm),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_gsm_11,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 13416 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd at 13420 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* gsm at 13423 */
};
static asn_CHOICE_specifics_t asn_SPC_modeSpecificInfo_specs_5 = {
	sizeof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo),
	offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo, _asn_ctx),
	offsetof(struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo, present),
	sizeof(((struct CellSelectReselectInfoSIB_11_12_ECN0__modeSpecificInfo *)0)->present),
...
static int asn_MAP_CellSelectReselectInfoSIB_11_12_ECN0_oms_1[] = { 0, 1, 2 };
static ber_tlv_tag_t asn_DEF_CellSelectReselectInfoSIB_11_12_ECN0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoSIB_11_12_ECN0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* q-Offset1S-N at 13411 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* q-Offset2S-N at 13412 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* maxAllowedUL-TX-Power at 13413 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* modeSpecificInfo at 13418 */
};
