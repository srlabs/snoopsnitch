...
int
SID_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SID_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SID_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SID_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SID_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SID_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SID_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SID_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SID_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_dec_rval_t
SID_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SID_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_SID_constr_1 = {
