...
static asn_TYPE_member_t asn_MBR_UE_IdleTimersAndConstants_v3a0ext_1[] = {
...
static int asn_MAP_UE_IdleTimersAndConstants_v3a0ext_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_UE_IdleTimersAndConstants_v3a0ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_IdleTimersAndConstants_v3a0ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* n-312 at 2805 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_IdleTimersAndConstants_v3a0ext_specs_1 = {
