...
static asn_TYPE_member_t asn_MBR_UEInformationRequest_r10_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct UEInformationRequest_r10_IEs, loggedMeasReportRequest),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct UEInformationRequest_r10_IEs, loggedANRReportRequest),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_UEInformationRequest_r10_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UEInformationRequest_r10_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UEInformationRequest_r10_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* loggedMeasReportRequest at 11541 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* loggedANRReportRequest at 11542 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UEInformationRequest_r10_IEs_specs_1 = {
	sizeof(struct UEInformationRequest_r10_IEs),
	offsetof(struct UEInformationRequest_r10_IEs, _asn_ctx),
	asn_MAP_UEInformationRequest_r10_IEs_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_UEInformationRequest_r10_IEs_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_UEInformationRequest_r10_IEs = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UEInformationRequest_r10_IEs_tags_1,
	sizeof(asn_DEF_UEInformationRequest_r10_IEs_tags_1)
		/sizeof(asn_DEF_UEInformationRequest_r10_IEs_tags_1[0]), /* 1 */
	asn_DEF_UEInformationRequest_r10_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_UEInformationRequest_r10_IEs_tags_1)
		/sizeof(asn_DEF_UEInformationRequest_r10_IEs_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_UEInformationRequest_r10_IEs_1,
	2,	/* Elements count */
	&asn_SPC_UEInformationRequest_r10_IEs_specs_1	/* Additional specs */
};
