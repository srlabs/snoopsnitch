...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_6 = {
	sizeof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions, rrcConnectionReleaseComplete_r3_add_ext),
	...
	{ ATF_POINTER, 1, offsetof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrcConnectionReleaseComplete-r3-add-ext at 8126 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 8127 */
};
static asn_SEQUENCE_specifics_t asn_SPC_laterNonCriticalExtensions_specs_4 = {
	sizeof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions),
	offsetof(struct RRCConnectionReleaseComplete__laterNonCriticalExtensions, _asn_ctx),
...
static int asn_MAP_RRCConnectionReleaseComplete_oms_1[] = { 1, 2 };
static ber_tlv_tag_t asn_DEF_RRCConnectionReleaseComplete_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionReleaseComplete_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrc-TransactionIdentifier at 8122 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* errorIndication at 8123 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* laterNonCriticalExtensions at 8126 */
};
