...
static asn_per_constraints_t asn_PER_type_PLMNsOfInterRATCellsList_constr_1 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_POINTER, 1, offsetof(struct PLMNsOfInterRATCellsList__Member, plmn_Identity),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* plmn-Identity at 17804 */
};
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_2 = {
	sizeof(struct PLMNsOfInterRATCellsList__Member),
	offsetof(struct PLMNsOfInterRATCellsList__Member, _asn_ctx),
...
static ber_tlv_tag_t asn_DEF_PLMNsOfInterRATCellsList_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
