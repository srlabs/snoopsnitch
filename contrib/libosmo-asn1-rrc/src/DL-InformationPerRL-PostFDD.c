...
static asn_TYPE_member_t asn_MBR_DL_InformationPerRL_PostFDD_1[] = {
...
static ber_tlv_tag_t asn_DEF_DL_InformationPerRL_PostFDD_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DL_InformationPerRL_PostFDD_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 7566 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-DPCH-InfoPerRL at 7568 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DL_InformationPerRL_PostFDD_specs_1 = {
