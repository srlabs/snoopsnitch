...
static asn_TYPE_member_t asn_MBR_MBMSAccessInformation_1[] = {
...
static int asn_MAP_MBMSAccessInformation_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_MBMSAccessInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_MBMSAccessInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mbms-ServiceAccessInfoList at 11183 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 11185 */
};
static asn_SEQUENCE_specifics_t asn_SPC_MBMSAccessInformation_specs_1 = {
