...
static asn_TYPE_member_t asn_MBR_UTRANMobilityInformation_v860ext1_IEs_1[] = {
...
static ber_tlv_tag_t asn_DEF_UTRANMobilityInformation_v860ext1_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UTRANMobilityInformation_v860ext1_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-ConnTimersAndConstants at 11081 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UTRANMobilityInformation_v860ext1_IEs_specs_1 = {
