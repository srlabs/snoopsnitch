...
static asn_TYPE_member_t asn_MBR_DL_AM_RLC_Mode_1[] = {
...
static ber_tlv_tag_t asn_DEF_DL_AM_RLC_Mode_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_DL_AM_RLC_Mode_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* inSequenceDelivery at 3515 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* receivingWindowSize at 3516 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dl-RLC-StatusInfo at 3518 */
};
static asn_SEQUENCE_specifics_t asn_SPC_DL_AM_RLC_Mode_specs_1 = {
