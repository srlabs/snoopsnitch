...
static asn_TYPE_member_t asn_MBR_Serving_HSDSCH_CellInformation_r7_1[] = {
	{ ATF_POINTER, 2, offsetof(struct Serving_HSDSCH_CellInformation_r7, deltaACK),
	...
	{ ATF_POINTER, 1, offsetof(struct Serving_HSDSCH_CellInformation_r7, deltaNACK),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct Serving_HSDSCH_CellInformation_r7, harq_Preamble_Mode),
	...
	{ ATF_POINTER, 4, offsetof(struct Serving_HSDSCH_CellInformation_r7, primaryCPICH_Info),
	...
	{ ATF_POINTER, 3, offsetof(struct Serving_HSDSCH_CellInformation_r7, dl_hspdsch_Information),
	...
	{ ATF_POINTER, 2, offsetof(struct Serving_HSDSCH_CellInformation_r7, harqInfo),
	...
	{ ATF_POINTER, 1, offsetof(struct Serving_HSDSCH_CellInformation_r7, mac_hsResetIndicator),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_Serving_HSDSCH_CellInformation_r7_oms_1[] = { 0, 1, 3, 4, 5, 6 };
static ber_tlv_tag_t asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_Serving_HSDSCH_CellInformation_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* deltaACK at 2209 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* deltaNACK at 2210 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* harq-Preamble-Mode at 2211 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* primaryCPICH-Info at 2212 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* dl-hspdsch-Information at 2213 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* harqInfo at 2214 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* mac-hsResetIndicator at 2215 */
};
static asn_SEQUENCE_specifics_t asn_SPC_Serving_HSDSCH_CellInformation_r7_specs_1 = {
	sizeof(struct Serving_HSDSCH_CellInformation_r7),
	offsetof(struct Serving_HSDSCH_CellInformation_r7, _asn_ctx),
	asn_MAP_Serving_HSDSCH_CellInformation_r7_tag2el_1,
	7,	/* Count of tags in the map */
	asn_MAP_Serving_HSDSCH_CellInformation_r7_oms_1,	/* Optional members */
	6, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_Serving_HSDSCH_CellInformation_r7 = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1,
	sizeof(asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1)
		/sizeof(asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1[0]), /* 1 */
	asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1,	/* Same as above */
	sizeof(asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1)
		/sizeof(asn_DEF_Serving_HSDSCH_CellInformation_r7_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_Serving_HSDSCH_CellInformation_r7_1,
	7,	/* Elements count */
	&asn_SPC_Serving_HSDSCH_CellInformation_r7_specs_1	/* Additional specs */
};
