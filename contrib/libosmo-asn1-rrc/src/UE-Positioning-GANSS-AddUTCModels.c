...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_AddUTCModels_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* utcModel1 at 18754 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* utcModel2 at 18755 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* utcModel3 at 18756 */
};
