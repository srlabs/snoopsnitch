...
static asn_TYPE_member_t asn_MBR_RRCConnectionSetupComplete_v3g0ext_IEs_1[] = {
...
static int asn_MAP_RRCConnectionSetupComplete_v3g0ext_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_RRCConnectionSetupComplete_v3g0ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionSetupComplete_v3g0ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-RadioAccessCapability-v3g0ext at 9008 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionSetupComplete_v3g0ext_IEs_specs_1 = {
