...
static int asn_MAP_SRNC_RelocationInfo_v5c0ext_IEs_oms_1[] = { 0 };
static ber_tlv_tag_t asn_DEF_SRNC_RelocationInfo_v5c0ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SRNC_RelocationInfo_v5c0ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-RadioAccessCapability-v5c0ext at 711 */
};
