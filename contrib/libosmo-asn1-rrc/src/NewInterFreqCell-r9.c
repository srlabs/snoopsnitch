...
static asn_TYPE_tag2member_t asn_MAP_tdd128_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* intraSecondaryFreqIndicator at 17360 */
};
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* noInfo at 17358 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd128 at 17361 */
};
...
static asn_TYPE_member_t asn_MBR_NewInterFreqCell_r9_1[] = {
...
static int asn_MAP_NewInterFreqCell_r9_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_NewInterFreqCell_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NewInterFreqCell_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* interFreqCellID at 17354 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* frequencyInfo at 17355 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* cellInfo at 17356 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* modeSpecificInfo at 17358 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NewInterFreqCell_r9_specs_1 = {
