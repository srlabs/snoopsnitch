...
static asn_TYPE_tag2member_t asn_MAP_sameAsLast_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* timeslotNumber at 12784 */
};
...
static asn_TYPE_tag2member_t asn_MAP_newParameters_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* individualTimeslotInfo at 12786 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ul-TS-ChannelisationCodeList at 12788 */
};
...
static asn_TYPE_tag2member_t asn_MAP_parameters_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sameAsLast at 12784 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* newParameters at 12786 */
};
...
static asn_TYPE_member_t asn_MBR_UplinkAdditionalTimeslots_LCR_r7_1[] = {
...
static ber_tlv_tag_t asn_DEF_UplinkAdditionalTimeslots_LCR_r7_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UplinkAdditionalTimeslots_LCR_r7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* parameters at 12784 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UplinkAdditionalTimeslots_LCR_r7_specs_1 = {
