...
static asn_TYPE_member_t asn_MBR_IntraFreqReportingCriteria_1b_r5_1[] = {
...
static ber_tlv_tag_t asn_DEF_IntraFreqReportingCriteria_1b_r5_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IntraFreqReportingCriteria_1b_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* periodicReportingInfo-1b at 16112 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IntraFreqReportingCriteria_1b_r5_specs_1 = {
