...
static asn_TYPE_member_t asn_MBR_PUSCH_SysInfo_HCR_r5_1[] = {
...
static int asn_MAP_PUSCH_SysInfo_HCR_r5_oms_1[] = { 2, 3 };
static ber_tlv_tag_t asn_DEF_PUSCH_SysInfo_HCR_r5_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PUSCH_SysInfo_HCR_r5_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pusch-Identity at 10598 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* pusch-Info at 10599 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* usch-TransportChannelsInfo at 10600 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* usch-TFCS at 10601 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PUSCH_SysInfo_HCR_r5_specs_1 = {
