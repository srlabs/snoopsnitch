...
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GANSS_AssistanceData_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-GANSS-ReferenceTime at 18823 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* uePositioningGanssReferencePosition at 18824 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* uePositioningGanssIonosphericModel at 18825 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* ganssGenericDataList at 18826 */
};
