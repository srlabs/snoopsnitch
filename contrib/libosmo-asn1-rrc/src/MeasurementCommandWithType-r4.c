...
static asn_per_constraints_t asn_PER_type_MeasurementCommandWithType_r4_constr_1 = {
...
static asn_TYPE_tag2member_t asn_MAP_MeasurementCommandWithType_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* setup at 1663 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* modify at 1664 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* release at 1665 */
};
