...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_6 = {
	sizeof(struct CounterCheckResponse__laterNonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct CounterCheckResponse__laterNonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_laterNonCriticalExtensions_4[] = {
	{ ATF_POINTER, 2, offsetof(struct CounterCheckResponse__laterNonCriticalExtensions, counterCheckResponse_r3_add_ext),
	...
	{ ATF_POINTER, 1, offsetof(struct CounterCheckResponse__laterNonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_TYPE_tag2member_t asn_MAP_laterNonCriticalExtensions_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* counterCheckResponse-r3-add-ext at 2312 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonCriticalExtensions at 2313 */
};
static asn_SEQUENCE_specifics_t asn_SPC_laterNonCriticalExtensions_specs_4 = {
	sizeof(struct CounterCheckResponse__laterNonCriticalExtensions),
	offsetof(struct CounterCheckResponse__laterNonCriticalExtensions, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_CounterCheckResponse_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct CounterCheckResponse, rb_COUNT_C_InformationList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct CounterCheckResponse, laterNonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static int asn_MAP_CounterCheckResponse_oms_1[] = { 1, 2 };
...
static asn_TYPE_tag2member_t asn_MAP_CounterCheckResponse_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rrc-TransactionIdentifier at 2307 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* rb-COUNT-C-InformationList at 2309 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* laterNonCriticalExtensions at 2312 */
};
static asn_SEQUENCE_specifics_t asn_SPC_CounterCheckResponse_specs_1 = {
	...
	asn_MAP_CounterCheckResponse_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
