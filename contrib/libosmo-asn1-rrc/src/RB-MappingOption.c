...
static asn_TYPE_member_t asn_MBR_RB_MappingOption_1[] = {
...
static int asn_MAP_RB_MappingOption_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RB_MappingOption_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RB_MappingOption_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-LogicalChannelMappings at 4294 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-LogicalChannelMappingList at 4295 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RB_MappingOption_specs_1 = {
