...
static asn_per_constraints_t asn_PER_type_DL_RLC_Mode_constr_1 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_DL_RLC_Mode_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_DL_RLC_Mode_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dl-AM-RLC-Mode at 3593 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* dl-UM-RLC-Mode at 3594 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* dl-TM-RLC-Mode at 3596 */
};
static asn_CHOICE_specifics_t asn_SPC_DL_RLC_Mode_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_DL_RLC_Mode = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_DL_RLC_Mode_constr_1,
