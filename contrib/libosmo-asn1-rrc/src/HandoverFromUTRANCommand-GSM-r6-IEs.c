...
static asn_per_constraints_t asn_PER_type_gsm_message_constr_5 = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_geran_SystemInfoType_constr_9 = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static ber_tlv_tag_t asn_DEF_single_GSM_Message_tags_6[] = {
...
static ber_tlv_tag_t asn_DEF_gsm_MessageList_tags_7[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_gsm_MessageList_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* gsm-Messages at 3339 */
};
...
static asn_TYPE_tag2member_t asn_MAP_gsm_message_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* single-GSM-Message at 3336 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* gsm-MessageList at 3339 */
};
...
asn_TYPE_descriptor_t asn_DEF_gsm_message_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_gsm_message_constr_5,
...
static asn_TYPE_tag2member_t asn_MAP_geran_SystemInfoType_tag2el_9[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* sI at 3342 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* pSI at 3344 */
};
...
asn_TYPE_descriptor_t asn_DEF_geran_SystemInfoType_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_geran_SystemInfoType_constr_9,
	asn_MBR_geran_SystemInfoType_9,
	2,	/* Elements count */
	&asn_SPC_geran_SystemInfoType_specs_9	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_HandoverFromUTRANCommand_GSM_r6_IEs_1[] = {
...
static int asn_MAP_HandoverFromUTRANCommand_GSM_r6_IEs_oms_1[] = { 0, 1, 4 };
static ber_tlv_tag_t asn_DEF_HandoverFromUTRANCommand_GSM_r6_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HandoverFromUTRANCommand_GSM_r6_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* activationTime at 3321 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* toHandoverRAB-Info at 3323 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* frequency-band at 3325 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* gsm-message at 3336 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* geran-SystemInfoType at 3342 */
};
static asn_SEQUENCE_specifics_t asn_SPC_HandoverFromUTRANCommand_GSM_r6_IEs_specs_1 = {
