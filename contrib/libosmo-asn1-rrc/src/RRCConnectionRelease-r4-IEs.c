...
static asn_TYPE_member_t asn_MBR_RRCConnectionRelease_r4_IEs_1[] = {
...
static int asn_MAP_RRCConnectionRelease_r4_IEs_oms_1[] = { 0, 2 };
static ber_tlv_tag_t asn_DEF_RRCConnectionRelease_r4_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RRCConnectionRelease_r4_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* n-308 at 7984 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* releaseCause at 7985 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* rplmn-information at 7986 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RRCConnectionRelease_r4_IEs_specs_1 = {
