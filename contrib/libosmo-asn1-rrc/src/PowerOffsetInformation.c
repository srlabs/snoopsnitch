...
static asn_TYPE_member_t asn_MBR_PowerOffsetInformation_1[] = {
...
static int asn_MAP_PowerOffsetInformation_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_PowerOffsetInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_PowerOffsetInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* gainFactorInformation at 5576 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* powerOffsetPp-m at 5578 */
};
static asn_SEQUENCE_specifics_t asn_SPC_PowerOffsetInformation_specs_1 = {
