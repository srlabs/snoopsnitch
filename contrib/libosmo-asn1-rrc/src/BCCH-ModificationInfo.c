...
static int asn_MAP_BCCH_ModificationInfo_oms_1[] = { 1 };
static ber_tlv_tag_t asn_DEF_BCCH_ModificationInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_BCCH_ModificationInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* mib-ValueTag at 20054 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* bcch-ModificationTime at 20055 */
};
