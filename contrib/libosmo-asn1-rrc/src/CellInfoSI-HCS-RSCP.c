...
static asn_TYPE_member_t asn_MBR_fdd_5[] = {
	{ ATF_POINTER, 2, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd, primaryCPICH_Info),
	...
	{ ATF_POINTER, 1, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd, primaryCPICH_TX_Power),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd, readSFN_Indicator),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd, tx_DiversityIndicator),
...
static asn_TYPE_tag2member_t asn_MAP_fdd_tag2el_5[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 13212 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* primaryCPICH-TX-Power at 13213 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* readSFN-Indicator at 13214 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* tx-DiversityIndicator at 13215 */
};
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_5 = {
	sizeof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd),
	offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd_10[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd, primaryCCPCH_Info),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd, primaryCCPCH_TX_Power),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd, timeslotInfoList),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd, readSFN_Indicator),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BOOLEAN,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_tdd_tag2el_10[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCCPCH-Info at 13218 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* primaryCCPCH-TX-Power at 13219 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* timeslotInfoList at 13220 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* readSFN-Indicator at 13221 */
};
static asn_SEQUENCE_specifics_t asn_SPC_tdd_specs_10 = {
	sizeof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd),
	offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo__tdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_5,
		0,	/* Defer constraints checking to the member type */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo, choice.tdd),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd_10,
		0,	/* Defer constraints checking to the member type */
...
static asn_TYPE_tag2member_t asn_MAP_modeSpecificInfo_tag2el_4[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* fdd at 13212 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tdd at 13218 */
};
static asn_CHOICE_specifics_t asn_SPC_modeSpecificInfo_specs_4 = {
	sizeof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo),
	offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo, _asn_ctx),
	offsetof(struct CellInfoSI_HCS_RSCP__modeSpecificInfo, present),
	sizeof(((struct CellInfoSI_HCS_RSCP__modeSpecificInfo *)0)->present),
...
static int asn_MAP_CellInfoSI_HCS_RSCP_oms_1[] = { 0, 1, 3 };
static ber_tlv_tag_t asn_DEF_CellInfoSI_HCS_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_CellInfoSI_HCS_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellIndividualOffset at 13208 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* referenceTimeDifferenceToCell at 13209 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* modeSpecificInfo at 13216 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* cellSelectionReselectionInfo at 13224 */
};
