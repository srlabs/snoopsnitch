...
static asn_per_constraints_t asn_PER_type_IntraFreqReportCriteria_r4_constr_1 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_IntraFreqReportCriteria_r4_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_IntraFreqReportCriteria_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqReportingCriteria at 16050 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* periodicalReportingCriteria at 16051 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* noReporting at 16053 */
};
static asn_CHOICE_specifics_t asn_SPC_IntraFreqReportCriteria_r4_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_IntraFreqReportCriteria_r4 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_IntraFreqReportCriteria_r4_constr_1,
