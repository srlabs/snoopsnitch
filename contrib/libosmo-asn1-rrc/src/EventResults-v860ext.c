...
static asn_per_constraints_t asn_PER_type_EventResults_v860ext_constr_1 = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_EventResults_v860ext_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_EventResults_v860ext_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* ue-positioning-MeasurementEventResults at 14375 */
};
static asn_CHOICE_specifics_t asn_SPC_EventResults_v860ext_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_EventResults_v860ext = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_EventResults_v860ext_constr_1,
