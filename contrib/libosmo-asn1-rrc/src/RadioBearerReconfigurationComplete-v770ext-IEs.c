...
static asn_TYPE_member_t asn_MBR_RadioBearerReconfigurationComplete_v770ext_IEs_1[] = {
	{ ATF_POINTER, 2, offsetof(struct RadioBearerReconfigurationComplete_v770ext_IEs, ext_UL_TimingAdvance),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioBearerReconfigurationComplete_v770ext_IEs, deferredMeasurementControlReading),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static int asn_MAP_RadioBearerReconfigurationComplete_v770ext_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RadioBearerReconfigurationComplete_v770ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ext-UL-TimingAdvance at 6134 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* deferredMeasurementControlReading at 6135 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RadioBearerReconfigurationComplete_v770ext_IEs_specs_1 = {
	sizeof(struct RadioBearerReconfigurationComplete_v770ext_IEs),
	offsetof(struct RadioBearerReconfigurationComplete_v770ext_IEs, _asn_ctx),
	asn_MAP_RadioBearerReconfigurationComplete_v770ext_IEs_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_RadioBearerReconfigurationComplete_v770ext_IEs_oms_1,	/* Optional members */
	2, 0,	/* Root/Additions */
	-1,	/* Start extensions */
	-1	/* Stop extensions */
};
asn_TYPE_descriptor_t asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs = {
	...
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1,
	sizeof(asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1)
		/sizeof(asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1[0]), /* 1 */
	asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1)
		/sizeof(asn_DEF_RadioBearerReconfigurationComplete_v770ext_IEs_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_RadioBearerReconfigurationComplete_v770ext_IEs_1,
	2,	/* Elements count */
	&asn_SPC_RadioBearerReconfigurationComplete_v770ext_IEs_specs_1	/* Additional specs */
};
