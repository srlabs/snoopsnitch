...
static asn_TYPE_member_t asn_MBR_IntraFreqMeasurementSysInfo_RSCP_LCR_r4_1[] = {
...
static int asn_MAP_IntraFreqMeasurementSysInfo_RSCP_LCR_r4_oms_1[] = { 0, 1, 2, 3, 4, 5 };
static ber_tlv_tag_t asn_DEF_IntraFreqMeasurementSysInfo_RSCP_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_IntraFreqMeasurementSysInfo_RSCP_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqMeasurementID at 16008 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* intraFreqCellInfoSI-List at 16009 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* intraFreqMeasQuantity at 16010 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* intraFreqReportingQuantityForRACH at 16011 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* maxReportedCellsOnRACH at 16012 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* reportingInfoForCellDCH at 16013 */
};
static asn_SEQUENCE_specifics_t asn_SPC_IntraFreqMeasurementSysInfo_RSCP_LCR_r4_specs_1 = {
