...
static asn_TYPE_member_t asn_MBR_NewInterFreqCellSI_RSCP_LCR_r4_1[] = {
...
static int asn_MAP_NewInterFreqCellSI_RSCP_LCR_r4_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_NewInterFreqCellSI_RSCP_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_NewInterFreqCellSI_RSCP_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* interFreqCellID at 17426 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* frequencyInfo at 17427 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* cellInfo at 17429 */
};
static asn_SEQUENCE_specifics_t asn_SPC_NewInterFreqCellSI_RSCP_LCR_r4_specs_1 = {
