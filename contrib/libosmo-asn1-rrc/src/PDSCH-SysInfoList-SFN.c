...
static asn_per_constraints_t asn_PER_type_PDSCH_SysInfoList_SFN_constr_1 = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 3,  3,  1,  8 }	/* (SIZE(1..8)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PDSCH_SysInfoList_SFN__Member, pdsch_SysInfo),
	...
	{ ATF_POINTER, 1, offsetof(struct PDSCH_SysInfoList_SFN__Member, sfn_TimeInfo),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* pdsch-SysInfo at 10072 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* sfn-TimeInfo at 10073 */
};
static asn_SEQUENCE_specifics_t asn_SPC_Member_specs_2 = {
	sizeof(struct PDSCH_SysInfoList_SFN__Member),
	offsetof(struct PDSCH_SysInfoList_SFN__Member, _asn_ctx),
...
static ber_tlv_tag_t asn_DEF_PDSCH_SysInfoList_SFN_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
