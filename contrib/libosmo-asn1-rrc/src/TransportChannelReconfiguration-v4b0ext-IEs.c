...
static int asn_MAP_TransportChannelReconfiguration_v4b0ext_IEs_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_TransportChannelReconfiguration_v4b0ext_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TransportChannelReconfiguration_v4b0ext_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dummy at 9739 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cell-id-PerRL-List at 9742 */
};
