...
static ber_tlv_tag_t asn_DEF_UE_RX_TX_TimeDifferenceType2Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_RX_TX_TimeDifferenceType2Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-RX-TX-TimeDifferenceType2 at 18634 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* neighbourQuality at 18636 */
};
