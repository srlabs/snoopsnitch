...
static int asn_MAP_UE_InternalMeasurement_r4_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UE_InternalMeasurement_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_InternalMeasurement_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-InternalMeasQuantity at 18557 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ue-InternalReportingQuantity at 18558 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* reportCriteria at 18560 */
};
