...
static asn_TYPE_member_t asn_MBR_InterFreqCellInfoSI_List_HCS_ECN0_1[] = {
...
static int asn_MAP_InterFreqCellInfoSI_List_HCS_ECN0_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_InterFreqCellInfoSI_List_HCS_ECN0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqCellInfoSI_List_HCS_ECN0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* removedInterFreqCellList at 15073 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* newInterFreqCellList at 15074 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqCellInfoSI_List_HCS_ECN0_specs_1 = {
