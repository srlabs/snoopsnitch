...
static asn_per_constraints_t asn_PER_memb_maxTFCIField2Value_constr_2 = {
...
static ber_tlv_tag_t asn_DEF_TFCI_Range_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TFCI_Range_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* maxTFCIField2Value at 5668 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tfcs-InfoForDSCH at 5670 */
};
