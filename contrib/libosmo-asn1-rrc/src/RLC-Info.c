...
static asn_TYPE_member_t asn_MBR_RLC_Info_1[] = {
...
static int asn_MAP_RLC_Info_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_RLC_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_RLC_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-RLC-Mode at 4361 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* dl-RLC-Mode at 4362 */
};
static asn_SEQUENCE_specifics_t asn_SPC_RLC_Info_specs_1 = {
