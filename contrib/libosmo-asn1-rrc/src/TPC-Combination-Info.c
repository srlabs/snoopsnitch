...
static asn_TYPE_member_t asn_MBR_TPC_Combination_Info_1[] = {
...
static ber_tlv_tag_t asn_DEF_TPC_Combination_Info_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TPC_Combination_Info_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* primaryCPICH-Info at 1986 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* tpc-CombinationIndex at 1988 */
};
static asn_SEQUENCE_specifics_t asn_SPC_TPC_Combination_Info_specs_1 = {
