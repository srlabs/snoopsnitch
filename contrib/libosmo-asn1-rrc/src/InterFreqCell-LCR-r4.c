...
static asn_TYPE_member_t asn_MBR_InterFreqCell_LCR_r4_1[] = {
...
static ber_tlv_tag_t asn_DEF_InterFreqCell_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InterFreqCell_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* frequencyInfo at 15007 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* nonFreqRelatedEventResults at 15009 */
};
static asn_SEQUENCE_specifics_t asn_SPC_InterFreqCell_LCR_r4_specs_1 = {
