...
static asn_TYPE_member_t asn_MBR_UE_Positioning_OTDOA_AssistanceData_UEB_1[] = {
...
static int asn_MAP_UE_Positioning_OTDOA_AssistanceData_UEB_oms_1[] = { 0, 1 };
static ber_tlv_tag_t asn_DEF_UE_Positioning_OTDOA_AssistanceData_UEB_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_UE_Positioning_OTDOA_AssistanceData_UEB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-OTDOA-ReferenceCellInfo-UEB at 19513 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ue-positioning-OTDOA-NeighbourCellList-UEB at 19515 */
};
static asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_OTDOA_AssistanceData_UEB_specs_1 = {
