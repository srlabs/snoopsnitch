...
static asn_per_constraints_t asn_PER_type_InterFreqReportCriteria_r6_constr_1 = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_InterFreqReportCriteria_r6_1[] = {
...
static asn_TYPE_tag2member_t asn_MAP_InterFreqReportCriteria_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* intraFreqReportingCriteria at 15309 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* interFreqReportingCriteria at 15310 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* periodicalReportingCriteria at 15311 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* noReporting at 15313 */
};
static asn_CHOICE_specifics_t asn_SPC_InterFreqReportCriteria_r6_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_InterFreqReportCriteria_r6 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_InterFreqReportCriteria_r6_constr_1,
