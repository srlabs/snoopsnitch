...
#ifndef	_UE_ConnTimersAndConstants_H_
#define	_UE_ConnTimersAndConstants_H_
...
typedef struct UE_ConnTimersAndConstants {
	...
	N_312_t	 n_312	/* DEFAULT 0 */;
	T_313_t	*t_313	/* DEFAULT 3 */;
	N_313_t	*n_313	/* DEFAULT 4 */;
	T_314_t	*t_314	/* DEFAULT 5 */;
	T_315_t	*t_315	/* DEFAULT 4 */;
	N_315_t	 n_315	/* DEFAULT 0 */;
	T_316_t	*t_316	/* DEFAULT 3 */;
	T_317_t	*t_317	/* DEFAULT 4 */;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} UE_ConnTimersAndConstants_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_UE_ConnTimersAndConstants;

#ifdef __cplusplus
}
#endif

#endif	/* _UE_ConnTimersAndConstants_H_ */
