...
#ifndef	_SRNC_RelocationInfo_r7_IEs_H_
#define	_SRNC_RelocationInfo_r7_IEs_H_
...
typedef struct SRNC_RelocationInfo_r7_IEs {
	...
	struct OngoingMeasRepList_r7	*ongoingMeasRepList	/* OPTIONAL */;
	InterRATCellInfoIndication_t	*interRATCellInfoIndication	/* OPTIONAL */;
	PredefinedConfigStatusList_t	 predefinedConfigStatusList;
	SRB_InformationSetupList_r7_t	 srb_InformationList;
	struct RAB_InformationSetupList_r7	*rab_InformationList	/* OPTIONAL */;
	struct UL_CommonTransChInfo_r4	*ul_CommonTransChInfo	/* OPTIONAL */;
	struct UL_AddReconfTransChInfoList_r7	*ul_TransChInfoList	/* OPTIONAL */;
	struct DL_CommonTransChInfo_r4	*dl_CommonTransChInfo	/* OPTIONAL */;
	struct DL_AddReconfTransChInfoList_r7	*dl_TransChInfoList	/* OPTIONAL */;
...
} SRNC_RelocationInfo_r7_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SRNC_RelocationInfo_r7_IEs;
...
#include "OngoingMeasRepList-r7.h"
...
#endif	/* _SRNC_RelocationInfo_r7_IEs_H_ */
