...
#ifndef	_SRNC_RelocationInfo_r5_IEs_H_
#define	_SRNC_RelocationInfo_r5_IEs_H_
...
/* Dependencies */
typedef enum SRNC_RelocationInfo_r5_IEs__dummy_PR {
	SRNC_RelocationInfo_r5_IEs__dummy_PR_NOTHING,	/* No components present */
	SRNC_RelocationInfo_r5_IEs__dummy_PR_fdd,
	SRNC_RelocationInfo_r5_IEs__dummy_PR_tdd
} SRNC_RelocationInfo_r5_IEs__dummy_PR;
...
typedef struct SRNC_RelocationInfo_r5_IEs {
	...
	UE_RadioAccessCapability_r5_t	 ue_RadioAccessCapability;
	...
	struct OngoingMeasRepList_r5	*ongoingMeasRepList	/* OPTIONAL */;
	PredefinedConfigStatusList_t	 predefinedConfigStatusList;
	SRB_InformationSetupList_r5_t	 srb_InformationList;
	struct RAB_InformationSetupList_r5	*rab_InformationList	/* OPTIONAL */;
	...
	struct SRNC_RelocationInfo_r5_IEs__dummy {
		SRNC_RelocationInfo_r5_IEs__dummy_PR present;
		union SRNC_RelocationInfo_r5_IEs__dummy_u {
			struct SRNC_RelocationInfo_r5_IEs__dummy__fdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} SRNC_RelocationInfo_r5_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SRNC_RelocationInfo_r5_IEs;
...
#include "OngoingMeasRepList-r5.h"
...
#endif	/* _SRNC_RelocationInfo_r5_IEs_H_ */
