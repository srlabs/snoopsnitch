...
#ifndef	_TransportChannelReconfiguration_r4_IEs_H_
#define	_TransportChannelReconfiguration_r4_IEs_H_
...
/* Dependencies */
typedef enum TransportChannelReconfiguration_r4_IEs__dummy_PR {
	TransportChannelReconfiguration_r4_IEs__dummy_PR_NOTHING,	/* No components present */
	TransportChannelReconfiguration_r4_IEs__dummy_PR_fdd,
	TransportChannelReconfiguration_r4_IEs__dummy_PR_tdd
} TransportChannelReconfiguration_r4_IEs__dummy_PR;
typedef enum TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR {
	TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_NOTHING,	/* No components present */
	TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_fdd,
	TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_tdd
} TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR;
...
typedef struct TransportChannelReconfiguration_r4_IEs {
	...
	struct TransportChannelReconfiguration_r4_IEs__dummy {
		TransportChannelReconfiguration_r4_IEs__dummy_PR present;
		union TransportChannelReconfiguration_r4_IEs__dummy_u {
			struct TransportChannelReconfiguration_r4_IEs__dummy__fdd {
	...
	struct TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo {
		TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR present;
		union TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo_u {
			struct TransportChannelReconfiguration_r4_IEs__modeSpecificPhysChInfo__fdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} TransportChannelReconfiguration_r4_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_TransportChannelReconfiguration_r4_IEs;
...
#endif	/* _TransportChannelReconfiguration_r4_IEs_H_ */
