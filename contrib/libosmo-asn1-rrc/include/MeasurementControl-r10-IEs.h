...
#ifndef	_MeasurementControl_r10_IEs_H_
#define	_MeasurementControl_r10_IEs_H_
...
typedef struct MeasurementControl_r10_IEs {
	MeasurementIdentity_t	 measurementIdentity;
	MeasurementCommand_r10_t	 measurementCommand;
...
} MeasurementControl_r10_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_MeasurementControl_r10_IEs;
...
#endif	/* _MeasurementControl_r10_IEs_H_ */
