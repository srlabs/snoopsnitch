...
#ifndef	_IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4_H_
#define	_IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4_H_
...
struct IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4;
...
typedef struct IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4 {
	MeasurementIdentity_t	*intraFreqMeasurementID	/* DEFAULT 1 */;
	struct IntraFreqCellInfoSI_List_HCS_RSCP_LCR_r4	*intraFreqCellInfoSI_List	/* OPTIONAL */;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4;
...
#endif	/* _IntraFreqMeasurementSysInfo_HCS_RSCP_LCR_r4_H_ */
