...
#ifndef	_RadioBearerSetup_r4_IEs_H_
#define	_RadioBearerSetup_r4_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerSetup_r4_IEs__dummy_PR {
	RadioBearerSetup_r4_IEs__dummy_PR_NOTHING,	/* No components present */
	RadioBearerSetup_r4_IEs__dummy_PR_fdd,
	RadioBearerSetup_r4_IEs__dummy_PR_tdd
} RadioBearerSetup_r4_IEs__dummy_PR;
typedef enum RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR {
	RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR_NOTHING,	/* No components present */
	RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR_fdd,
	RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR_tdd
} RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR;
...
typedef struct RadioBearerSetup_r4_IEs {
	...
	struct RadioBearerSetup_r4_IEs__dummy {
		RadioBearerSetup_r4_IEs__dummy_PR present;
		union RadioBearerSetup_r4_IEs__dummy_u {
			struct RadioBearerSetup_r4_IEs__dummy__fdd {
	...
	struct RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo {
		RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_PR present;
		union RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo_u {
			struct RadioBearerSetup_r4_IEs__modeSpecificPhysChInfo__fdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerSetup_r4_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerSetup_r4_IEs;
...
#endif	/* _RadioBearerSetup_r4_IEs_H_ */
