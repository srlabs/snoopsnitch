...
#ifndef	_RadioBearerReconfiguration_r11_IEs_H_
#define	_RadioBearerReconfiguration_r11_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerReconfiguration_r11_IEs__responseToChangeOfUE_Capability {
	RadioBearerReconfiguration_r11_IEs__responseToChangeOfUE_Capability_true	= 0
} e_RadioBearerReconfiguration_r11_IEs__responseToChangeOfUE_Capability;
typedef enum RadioBearerReconfiguration_r11_IEs__specificationMode_PR {
	RadioBearerReconfiguration_r11_IEs__specificationMode_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r11_IEs__specificationMode_PR_complete,
	RadioBearerReconfiguration_r11_IEs__specificationMode_PR_preconfiguration
} RadioBearerReconfiguration_r11_IEs__specificationMode_PR;
typedef enum RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR {
	RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR_predefinedConfigIdentity,
	RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR_defaultConfig
} RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR;
...
typedef struct RadioBearerReconfiguration_r11_IEs {
	...
	struct RadioBearerReconfiguration_r11_IEs__specificationMode {
		RadioBearerReconfiguration_r11_IEs__specificationMode_PR present;
		union RadioBearerReconfiguration_r11_IEs__specificationMode_u {
			struct RadioBearerReconfiguration_r11_IEs__specificationMode__complete {
				...
				struct RB_IdentityList	*umRlc_ReEstablishmentRBList	/* OPTIONAL */;
			...
			struct RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration {
				struct RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode {
					RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_PR present;
					union RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode_u {
						PredefinedConfigIdentity_t	 predefinedConfigIdentity;
						struct RadioBearerReconfiguration_r11_IEs__specificationMode__preconfiguration__preConfigMode__defaultConfig {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerReconfiguration_r11_IEs_t;

/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_responseToChangeOfUE_Capability_18;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerReconfiguration_r11_IEs;
...
#endif	/* _RadioBearerReconfiguration_r11_IEs_H_ */
