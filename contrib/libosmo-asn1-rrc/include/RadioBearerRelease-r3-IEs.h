...
#ifndef	_RadioBearerRelease_r3_IEs_H_
#define	_RadioBearerRelease_r3_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerRelease_r3_IEs__dummy_PR {
	RadioBearerRelease_r3_IEs__dummy_PR_NOTHING,	/* No components present */
	RadioBearerRelease_r3_IEs__dummy_PR_fdd,
	RadioBearerRelease_r3_IEs__dummy_PR_tdd
} RadioBearerRelease_r3_IEs__dummy_PR;
typedef enum RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR {
	RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR_NOTHING,	/* No components present */
	RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR_fdd,
	RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR_tdd
} RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR;
...
typedef struct RadioBearerRelease_r3_IEs {
	...
	struct RadioBearerRelease_r3_IEs__dummy {
		RadioBearerRelease_r3_IEs__dummy_PR present;
		union RadioBearerRelease_r3_IEs__dummy_u {
			struct RadioBearerRelease_r3_IEs__dummy__fdd {
	...
	struct RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo {
		RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_PR present;
		union RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo_u {
			struct RadioBearerRelease_r3_IEs__modeSpecificPhysChInfo__fdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerRelease_r3_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerRelease_r3_IEs;
...
#endif	/* _RadioBearerRelease_r3_IEs_H_ */
