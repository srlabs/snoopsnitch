...
#ifndef	_PhysicalChannelReconfiguration_r7_IEs_H_
#define	_PhysicalChannelReconfiguration_r7_IEs_H_
...
/* Dependencies */
typedef enum PhysicalChannelReconfiguration_r7_IEs__responseToChangeOfUE_Capability {
	PhysicalChannelReconfiguration_r7_IEs__responseToChangeOfUE_Capability_true	= 0
} e_PhysicalChannelReconfiguration_r7_IEs__responseToChangeOfUE_Capability;
...
typedef struct PhysicalChannelReconfiguration_r7_IEs {
...
} PhysicalChannelReconfiguration_r7_IEs_t;

/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_responseToChangeOfUE_Capability_18;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_PhysicalChannelReconfiguration_r7_IEs;
...
#endif	/* _PhysicalChannelReconfiguration_r7_IEs_H_ */
