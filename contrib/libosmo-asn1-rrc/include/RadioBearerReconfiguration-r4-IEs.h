...
#ifndef	_RadioBearerReconfiguration_r4_IEs_H_
#define	_RadioBearerReconfiguration_r4_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerReconfiguration_r4_IEs__dummy_PR {
	RadioBearerReconfiguration_r4_IEs__dummy_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r4_IEs__dummy_PR_fdd,
	RadioBearerReconfiguration_r4_IEs__dummy_PR_tdd
} RadioBearerReconfiguration_r4_IEs__dummy_PR;
typedef enum RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR {
	RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_NOTHING,	/* No components present */
	RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_fdd,
	RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR_tdd
} RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR;
...
typedef struct RadioBearerReconfiguration_r4_IEs {
	...
	struct RadioBearerReconfiguration_r4_IEs__dummy {
		RadioBearerReconfiguration_r4_IEs__dummy_PR present;
		union RadioBearerReconfiguration_r4_IEs__dummy_u {
			struct RadioBearerReconfiguration_r4_IEs__dummy__fdd {
	...
	struct RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo {
		RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_PR present;
		union RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo_u {
			struct RadioBearerReconfiguration_r4_IEs__modeSpecificPhysChInfo__fdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerReconfiguration_r4_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerReconfiguration_r4_IEs;
...
#include "RB-InformationReconfigList-r4.h"
...
#endif	/* _RadioBearerReconfiguration_r4_IEs_H_ */
