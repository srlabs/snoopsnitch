...
#ifndef	_CellInfoSI_HCS_ECN0_H_
#define	_CellInfoSI_HCS_ECN0_H_
...
/* Dependencies */
typedef enum CellInfoSI_HCS_ECN0__modeSpecificInfo_PR {
	CellInfoSI_HCS_ECN0__modeSpecificInfo_PR_NOTHING,	/* No components present */
	CellInfoSI_HCS_ECN0__modeSpecificInfo_PR_fdd,
	CellInfoSI_HCS_ECN0__modeSpecificInfo_PR_tdd
} CellInfoSI_HCS_ECN0__modeSpecificInfo_PR;
...
/* CellInfoSI-HCS-ECN0 */
typedef struct CellInfoSI_HCS_ECN0 {
	...
	struct CellInfoSI_HCS_ECN0__modeSpecificInfo {
		CellInfoSI_HCS_ECN0__modeSpecificInfo_PR present;
		union CellInfoSI_HCS_ECN0__modeSpecificInfo_u {
			struct CellInfoSI_HCS_ECN0__modeSpecificInfo__fdd {
			...
			struct CellInfoSI_HCS_ECN0__modeSpecificInfo__tdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} CellInfoSI_HCS_ECN0_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_CellInfoSI_HCS_ECN0;
