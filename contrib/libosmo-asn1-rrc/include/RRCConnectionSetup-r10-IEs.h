...
#ifndef	_RRCConnectionSetup_r10_IEs_H_
#define	_RRCConnectionSetup_r10_IEs_H_
...
/* Dependencies */
typedef enum RRCConnectionSetup_r10_IEs__specificationMode_PR {
	RRCConnectionSetup_r10_IEs__specificationMode_PR_NOTHING,	/* No components present */
	RRCConnectionSetup_r10_IEs__specificationMode_PR_complete,
	RRCConnectionSetup_r10_IEs__specificationMode_PR_preconfiguration
} RRCConnectionSetup_r10_IEs__specificationMode_PR;
typedef enum RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR {
	RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR_NOTHING,	/* No components present */
	RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR_predefinedConfigIdentity,
	RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR_defaultConfig
} RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR;
...
typedef struct RRCConnectionSetup_r10_IEs {
	...
	struct RRCConnectionSetup_r10_IEs__specificationMode {
		RRCConnectionSetup_r10_IEs__specificationMode_PR present;
		union RRCConnectionSetup_r10_IEs__specificationMode_u {
			struct RRCConnectionSetup_r10_IEs__specificationMode__complete {
			...
			struct RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration {
				struct RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode {
					RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_PR present;
					union RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode_u {
						PredefinedConfigIdentity_t	 predefinedConfigIdentity;
						struct RRCConnectionSetup_r10_IEs__specificationMode__preconfiguration__preConfigMode__defaultConfig {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RRCConnectionSetup_r10_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RRCConnectionSetup_r10_IEs;
...
#endif	/* _RRCConnectionSetup_r10_IEs_H_ */
