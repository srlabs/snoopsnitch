...
#ifndef	_IntraFreqMeasurementSysInfo_ECN0_H_
#define	_IntraFreqMeasurementSysInfo_ECN0_H_
...
struct IntraFreqCellInfoSI_List_ECN0;
...
typedef struct IntraFreqMeasurementSysInfo_ECN0 {
	MeasurementIdentity_t	*intraFreqMeasurementID	/* DEFAULT 1 */;
	struct IntraFreqCellInfoSI_List_ECN0	*intraFreqCellInfoSI_List	/* OPTIONAL */;
...
} IntraFreqMeasurementSysInfo_ECN0_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_IntraFreqMeasurementSysInfo_ECN0;
...
#endif	/* _IntraFreqMeasurementSysInfo_ECN0_H_ */
