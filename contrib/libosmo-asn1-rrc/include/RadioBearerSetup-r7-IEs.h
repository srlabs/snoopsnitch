...
#ifndef	_RadioBearerSetup_r7_IEs_H_
#define	_RadioBearerSetup_r7_IEs_H_
...
/* Dependencies */
typedef enum RadioBearerSetup_r7_IEs__specificationMode_PR {
	RadioBearerSetup_r7_IEs__specificationMode_PR_NOTHING,	/* No components present */
	RadioBearerSetup_r7_IEs__specificationMode_PR_complete,
	RadioBearerSetup_r7_IEs__specificationMode_PR_dummy
} RadioBearerSetup_r7_IEs__specificationMode_PR;
...
struct SRB_InformationSetupList_r7;
...
typedef struct RadioBearerSetup_r7_IEs {
	...
	struct RadioBearerSetup_r7_IEs__specificationMode {
		RadioBearerSetup_r7_IEs__specificationMode_PR present;
		union RadioBearerSetup_r7_IEs__specificationMode_u {
			struct RadioBearerSetup_r7_IEs__specificationMode__complete {
				struct SRB_InformationSetupList_r7	*srb_InformationSetupList	/* OPTIONAL */;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RadioBearerSetup_r7_IEs_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_RadioBearerSetup_r7_IEs;
...
#endif	/* _RadioBearerSetup_r7_IEs_H_ */
