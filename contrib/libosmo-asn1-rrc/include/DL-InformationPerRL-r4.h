...
/* Dependencies */
typedef enum DL_InformationPerRL_r4__modeSpecificInfo_PR {
	DL_InformationPerRL_r4__modeSpecificInfo_PR_NOTHING,	/* No components present */
	DL_InformationPerRL_r4__modeSpecificInfo_PR_fdd,
	DL_InformationPerRL_r4__modeSpecificInfo_PR_tdd
} DL_InformationPerRL_r4__modeSpecificInfo_PR;
...
typedef struct DL_InformationPerRL_r4 {
	struct DL_InformationPerRL_r4__modeSpecificInfo {
		DL_InformationPerRL_r4__modeSpecificInfo_PR present;
		union DL_InformationPerRL_r4__modeSpecificInfo_u {
			struct DL_InformationPerRL_r4__modeSpecificInfo__fdd {
