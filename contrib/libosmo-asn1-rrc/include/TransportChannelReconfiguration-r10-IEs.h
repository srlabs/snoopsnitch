...
#ifndef	_TransportChannelReconfiguration_r10_IEs_H_
#define	_TransportChannelReconfiguration_r10_IEs_H_
...
/* Dependencies */
typedef enum TransportChannelReconfiguration_r10_IEs__responseToChangeOfUE_Capability {
	TransportChannelReconfiguration_r10_IEs__responseToChangeOfUE_Capability_true	= 0
} e_TransportChannelReconfiguration_r10_IEs__responseToChangeOfUE_Capability;
...
typedef struct TransportChannelReconfiguration_r10_IEs {
...
} TransportChannelReconfiguration_r10_IEs_t;

/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_responseToChangeOfUE_Capability_18;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_TransportChannelReconfiguration_r10_IEs;
...
#endif	/* _TransportChannelReconfiguration_r10_IEs_H_ */
