...
#ifndef	_DL_DPCH_InfoPerRL_r7_H_
#define	_DL_DPCH_InfoPerRL_r7_H_
...
/* Dependencies */
typedef enum DL_DPCH_InfoPerRL_r7_PR {
	DL_DPCH_InfoPerRL_r7_PR_NOTHING,	/* No components present */
	DL_DPCH_InfoPerRL_r7_PR_fdd,
	DL_DPCH_InfoPerRL_r7_PR_tdd
} DL_DPCH_InfoPerRL_r7_PR;
...
typedef struct DL_DPCH_InfoPerRL_r7 {
	DL_DPCH_InfoPerRL_r7_PR present;
	union DL_DPCH_InfoPerRL_r7_u {
		struct DL_DPCH_InfoPerRL_r7__fdd {
		...
		struct DL_DPCH_InfoPerRL_r7__tdd {
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} DL_DPCH_InfoPerRL_r7_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_DL_DPCH_InfoPerRL_r7;
...
#endif	/* _DL_DPCH_InfoPerRL_r7_H_ */
