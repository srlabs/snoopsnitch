...
\FIXME{Shouldn't that be CIPHER MODE COMMAND?}
...
\FIXME{What if we sent multiple CIPHER MODE COMPLETE messages?}
...
cell BCCH carriers at least every 5 minutes." \cite[section 6.6.1]{tc1996gsm}
