...
\FIXME{Add Android API call to retrieve $LAC_{sc}$.}

$CID_{sc}$: Android API

\FIXME{Add Android API call to retrieve $CID_{sc}$.}

$ARFCN_{sc}$: ???

\FIXME{On Qualcomm we currently cannot correlate an ARFCN with the serving cell.}
...
\FIXME{Add Android API call to retrieve $NL$.}
...
\FIXME{Add Android API call or RIL call to retrieve $RAT$.}
...
\FIXME{Add Android API call to retrieve $NL_{sc}$.}
...
\FIXME{On Qualcomm we currently cannot correlate an ARFCN with the serving
cell, i.e. we cannot distinguish serving cell SI3 information from neighboring
cell SI3 information.}

\FIXME{Which DB field?}
...
\FIXME{Check this list for correctness and completeness.}
...
\FIXME{Find Android API call or Android RIL call to retrieve $TX$.}
...
\FIXME{On Qualcomm we currently cannot correlate an ARFCN with the serving
cell, i.e. we cannot distinguish serving cell SI2 information from neighboring
cell SI2 information.}
